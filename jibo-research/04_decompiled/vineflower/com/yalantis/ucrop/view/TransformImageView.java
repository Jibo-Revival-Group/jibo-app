...
public class TransformImageView extends ImageView {
   ...
   public float getMatrixAngle(Matrix var1) {
      return (float)(-(Math.atan2(this.getMatrixValue(var1, 1), this.getMatrixValue(var1, 0)) * (180.0 / Math.PI)));
   }

   public float getMatrixScale(Matrix var1) {
      return (float)Math.sqrt(Math.pow(this.getMatrixValue(var1, 0), 2.0) + Math.pow(this.getMatrixValue(var1, 3), 2.0));
   }
   ...
   public Bitmap getViewBitmap() {
      ...
      if (this.getDrawable() != null && this.getDrawable() instanceof FastBitmapDrawable) {
         var1 = ((FastBitmapDrawable)this.getDrawable()).getBitmap();
      } else {
         var1 = null;
      }
   ...
   protected void onImageLaidOut() {
      ...
      if (var3 != null) {
         float var2 = var3.getIntrinsicWidth();
         float var1 = var3.getIntrinsicHeight();
         Log.d("TransformImageView", String.format("Image size: [%d:%d]", (int)var2, (int)var1));
         RectF var4 = new RectF(0.0F, 0.0F, var2, var1);
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (var1 || this.mBitmapDecoded && !this.mBitmapLaidOut) {
         ...
         this.mThisWidth = var6 - var2 - var4;
         this.mThisHeight = var5 - var7 - var3;
         this.onImageLaidOut();
      }
   }
   ...
   protected void printMatrix(String var1, Matrix var2) {
      float var5 = this.getMatrixValue(var2, 2);
      float var3 = this.getMatrixValue(var2, 5);
      float var6 = this.getMatrixScale(var2);
      float var4 = this.getMatrixAngle(var2);
      Log.d("TransformImageView", var1 + ": matrix: { x: " + var5 + ", y: " + var3 + ", scale: " + var6 + ", angle: " + var4 + " }");
   }
   ...
   public void setImageUri(Uri var1, Uri var2) throws Exception {
      ...
      BitmapLoadUtils.decodeBitmapInBackground(this.getContext(), var1, var2, var3, var3, new BitmapLoadCallback(this) {
         ...
         @Override
         public void onBitmapLoaded(Bitmap var1, ExifInfo var2x, String var3x, String var4) {
            this.this$0.mImageInputPath = var3x;
            this.this$0.mImageOutputPath = var4;
            this.this$0.mExifInfo = var2x;
            this.this$0.mBitmapDecoded = true;
            this.this$0.setImageBitmap(var1);
         }
         ...
         public void onFailure(Exception var1) {
            ...
            if (this.this$0.mTransformImageListener != null) {
               this.this$0.mTransformImageListener.onLoadFailure(var1);
            }
         }
      });
   }
