...
public class UCrop {
   ...
   private UCrop(Uri var1, Uri var2) {
      this.mCropOptionsBundle.putParcelable("com.yalantis.ucrop.InputUri", var1);
   ...
   public static UCrop of(Uri var0, Uri var1) {
   ...
   public void start(Context var1, android.support.v4.app.Fragment var2) {
      this.start(var1, var2, 69);
   }

   public void start(Context var1, android.support.v4.app.Fragment var2, int var3) {
      var2.startActivityForResult(this.getIntent(var1), var3);
   }
   ...
   public UCrop withMaxResultSize(int var1, int var2) {
      this.mCropOptionsBundle.putInt("com.yalantis.ucrop.MaxSizeX", var1);
      this.mCropOptionsBundle.putInt("com.yalantis.ucrop.MaxSizeY", var2);
      return this;
   }
   ...
   public static class Options {
      ...
      public static final String EXTRA_CROP_PADDING = "com.yalantis.ucrop.CropPadding";
      ...
      public void setAspectRatioOptions(int var1, AspectRatio... var2) {
         if (var1 > var2.length) {
            throw new IllegalArgumentException(
               String.format(Locale.US, "Index [selectedByDefault = %d] cannot be higher than aspect ratio options count [count = %d].", var1, var2.length)
            );
         }
      ...
      public void setCropPadding(int var1) {
         this.mOptionBundle.putInt("com.yalantis.ucrop.CropPadding", var1);
      }
      ...
      public void setOvalDimmedLayer(boolean var1) {
         this.mOptionBundle.putBoolean("com.yalantis.ucrop.OvalDimmedLayer", var1);
      }
