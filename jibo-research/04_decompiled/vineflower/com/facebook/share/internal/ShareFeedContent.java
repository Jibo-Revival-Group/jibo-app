...
public class ShareFeedContent extends ShareContent<ShareFeedContent, ShareFeedContent.Builder> {
   ...
   public static final class Builder extends ShareContent.Builder<ShareFeedContent, ShareFeedContent.Builder> {
      ...
      public ShareFeedContent.Builder readFrom(ShareFeedContent var1) {
         ShareFeedContent.Builder var2;
         if (var1 == null) {
            var2 = this;
         } else {
            var2 = ((ShareFeedContent.Builder)super.readFrom(var1))
               .setToId(var1.getToId())
               .setLink(var1.getLink())
               .setLinkName(var1.getLinkName())
               .setLinkCaption(var1.getLinkCaption())
               .setLinkDescription(var1.getLinkDescription())
               .setPicture(var1.getPicture())
               .setMediaSource(var1.getMediaSource());
         }
