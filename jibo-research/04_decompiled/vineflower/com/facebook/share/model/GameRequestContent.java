...
public final class GameRequestContent implements ShareModel {
   ...
   public String getTo() {
      ...
      if (this.getRecipients() != null) {
         var1 = TextUtils.join(",", this.getRecipients());
      } else {
         var1 = null;
      }
   ...
   public enum ActionType {
      ...
      private static final GameRequestContent.ActionType[] $VALUES = new GameRequestContent.ActionType[]{
         GameRequestContent.ActionType.SEND, GameRequestContent.ActionType.ASKFOR, GameRequestContent.ActionType.TURN
      };
   }
   ...
   public static class Builder implements ShareModelBuilder<GameRequestContent, GameRequestContent.Builder> {
      ...
      public GameRequestContent.Builder readFrom(GameRequestContent var1) {
         GameRequestContent.Builder var2;
         if (var1 == null) {
            var2 = this;
         } else {
            var2 = this.setMessage(var1.getMessage())
               .setRecipients(var1.getRecipients())
               .setTitle(var1.getTitle())
               .setData(var1.getData())
               .setActionType(var1.getActionType())
               .setObjectId(var1.getObjectId())
               .setFilters(var1.getFilters())
               .setSuggestions(var1.getSuggestions());
         }
   ...
   public enum Filters {
      ...
      private static final GameRequestContent.Filters[] $VALUES = new GameRequestContent.Filters[]{
         GameRequestContent.Filters.APP_USERS, GameRequestContent.Filters.APP_NON_USERS
      };
   }
}
