...
final class ProfileCache {
   ...
   private final SharedPreferences sharedPreferences = FacebookSdk.getApplicationContext()
      .getSharedPreferences("com.facebook.AccessTokenManager.SharedPreferences", 0);
   ...
   Profile load() {
      String var1 = this.sharedPreferences.getString("com.facebook.ProfileManager.CachedProfile", null);
      if (var1 != null) {
         try {
            JSONObject var2 = new JSONObject(var1);
            return new Profile(var2);
