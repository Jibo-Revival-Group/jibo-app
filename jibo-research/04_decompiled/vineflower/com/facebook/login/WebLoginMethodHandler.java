...
abstract class WebLoginMethodHandler extends LoginMethodHandler {
   ...
   private String loadCookieToken() {
      return this.loginClient
         .getActivity()
         .getSharedPreferences("com.facebook.login.AuthorizationClient.WebViewAuthHandler.TOKEN_STORE_KEY", 0)
         .getString("TOKEN", "");
   }
   ...
   protected Bundle getParameters(LoginClient.Request var1) {
      ...
      if (!Utility.isNullOrEmpty(var1.getPermissions())) {
   ...
   protected void onComplete(LoginClient.Request var1, Bundle var2, FacebookException var3) {
      ...
      if (var2 != null) {
         ...
         try {
            AccessToken var8 = createAccessTokenFromWebBundle(var1.getPermissions(), var2, this.getTokenSource(), var1.getApplicationId());
            var5 = LoginClient.Result.createTokenResult(this.loginClient.getPendingRequest(), var8);
            CookieSyncManager.createInstance(this.loginClient.getActivity()).sync();
            this.saveCookieToken(var8.getToken());
         } catch (FacebookException var4) {
            var5 = LoginClient.Result.createErrorResult(this.loginClient.getPendingRequest(), null, var4.getMessage());
         }
         ...
         if (var3 instanceof FacebookServiceException) {
            FacebookRequestError var7 = ((FacebookServiceException)var3).getRequestError();
            var9 = String.format(Locale.ROOT, "%d", var7.getErrorCode());
            var6 = var7.toString();
         } else {
            var9 = null;
         }

         var5 = LoginClient.Result.createErrorResult(this.loginClient.getPendingRequest(), null, var6, var9);
      }
