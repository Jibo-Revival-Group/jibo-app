...
public class ToolTipPopup {
   ...
   public ToolTipPopup(String var1, View var2) {
      ...
      this.mScrollListener = new OnScrollChangedListener(this) {
   ...
   public void show() {
      if (this.mAnchorViewRef.get() != null) {
         ...
         if (this.mNuxDisplayTime > 0L) {
            this.mPopupContent.postDelayed(new Runnable(this) {
               final ToolTipPopup this$0;
         ...
         this.mPopupContent.setOnClickListener(new OnClickListener(this) {
            final ToolTipPopup this$0;
   ...
   private class PopupContentView extends FrameLayout {
      ...
      public PopupContentView(ToolTipPopup var1, Context var2) {
         super(var2);
         this.this$0 = var1;
         this.init();
      }
   ...
   public enum Style {
      ...
      private static final ToolTipPopup.Style[] $VALUES = new ToolTipPopup.Style[]{ToolTipPopup.Style.BLUE, ToolTipPopup.Style.BLACK};
   }
}
