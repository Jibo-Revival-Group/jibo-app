...
public abstract class ProfileTracker {
   ...
   public ProfileTracker() {
      ...
      this.receiver = new ProfileTracker.ProfileBroadcastReceiver(this);
   ...
   private class ProfileBroadcastReceiver extends BroadcastReceiver {
      ...
      private ProfileBroadcastReceiver(ProfileTracker var1) {
         this.this$0 = var1;
      }
      ...
      public void onReceive(Context var1, Intent var2) {
         if ("com.facebook.sdk.ACTION_CURRENT_PROFILE_CHANGED".equals(var2.getAction())) {
            ...
            this.this$0.onCurrentProfileChanged(var3, var4);
         }
      }
   }
}
