...
public class CaseFeedResponse {
   ...
   private List<CaseFeedResponse.Element> elements;
   @SerializedName(a = "nextPageUrl")
   private String nextPageUrl;
   @SerializedName(a = "updatesUrl")
   ...
   public List<CaseFeedResponse.Element> b() {
      List var1;
      if (this.elements == null) {
         var1 = Collections.emptyList();
      } else {
         var1 = Collections.unmodifiableList(this.elements);
      }
