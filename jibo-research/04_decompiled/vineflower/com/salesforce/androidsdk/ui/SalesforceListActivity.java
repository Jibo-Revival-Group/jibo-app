...
public abstract class SalesforceListActivity extends ListActivity {
      ...
      if (this.a.b(this)) {
         new ClientManager(this, SalesforceSDKManager.a().B(), SalesforceSDKManager.a().h(), SalesforceSDKManager.a().j())
            .a(this, new ClientManager.RestClientCallback(this) {
               final SalesforceListActivity a;
   ...
   protected void onCreate(Bundle var1) {
      ...
      this.b = new SalesforceListActivity.ActivityUserSwitchReceiver(this);
      this.registerReceiver(this.b, new IntentFilter("com.salesforce.USERSWITCHED"));
      this.c = new SalesforceListActivity.ActivityLogoutCompleteReceiver(this);
   ...
   private class ActivityLogoutCompleteReceiver extends LogoutCompleteReceiver {
      ...
      private ActivityLogoutCompleteReceiver(SalesforceListActivity var1) {
         this.a = var1;
      }
   ...
   private class ActivityUserSwitchReceiver extends UserSwitchReceiver {
      ...
      private ActivityUserSwitchReceiver(SalesforceListActivity var1) {
         this.a = var1;
      }
