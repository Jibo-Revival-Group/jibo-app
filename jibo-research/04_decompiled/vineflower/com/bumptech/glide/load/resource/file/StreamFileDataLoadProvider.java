...
public class StreamFileDataLoadProvider implements DataLoadProvider<InputStream, File> {
   ...
   private static class ErrorSourceDecoder implements ResourceDecoder<InputStream, File> {
      ...
      public Resource<File> a(InputStream var1, int var2, int var3) {
         throw new Error(
            "You cannot decode a File from an InputStream by default, try either #diskCacheStratey(DiskCacheStrategy.SOURCE) to avoid this call or #decoder(ResourceDecoder) to replace this Decoder"
         );
      }
