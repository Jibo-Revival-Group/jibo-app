...
public class FileDescriptorUriLoader extends UriLoader<ParcelFileDescriptor> implements FileDescriptorModelLoader<Uri> {
   public FileDescriptorUriLoader(Context var1, ModelLoader<GlideUrl, ParcelFileDescriptor> var2) {
      super(var1, var2);
   }

   @Override
   protected DataFetcher<ParcelFileDescriptor> getAssetPathFetcher(Context var1, String var2) {
      return new FileDescriptorAssetPathFetcher(var1.getApplicationContext().getAssets(), var2);
   }

   @Override
   protected DataFetcher<ParcelFileDescriptor> getLocalUriFetcher(Context var1, Uri var2) {
   ...
   public static class Factory implements ModelLoaderFactory<Uri, ParcelFileDescriptor> {
      @Override
      public ModelLoader<Uri, ParcelFileDescriptor> build(Context var1, GenericLoaderFactory var2) {
