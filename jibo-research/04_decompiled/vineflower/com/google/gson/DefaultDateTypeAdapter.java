...
final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
   ...
   public DefaultDateTypeAdapter(Class<? extends Date> var1, int var2, int var3) {
      this(var1, DateFormat.getDateTimeInstance(var2, var3, Locale.US), DateFormat.getDateTimeInstance(var2, var3));
   }

   DefaultDateTypeAdapter(Class<? extends Date> var1, String var2) {
      this(var1, new SimpleDateFormat(var2, Locale.US), new SimpleDateFormat(var2));
   }

   DefaultDateTypeAdapter(Class<? extends Date> var1, DateFormat var2, DateFormat var3) {
   ...
   private Date a(String param1) {
      ...
      // Bytecode:
      // 00: aload 0
      // 01: getfield com/google/gson/DefaultDateTypeAdapter.c Ljava/text/DateFormat;
      // 04: astore 3
      // 05: aload 3
      // 06: monitorenter
      // 07: aload 0
      // 08: getfield com/google/gson/DefaultDateTypeAdapter.c Ljava/text/DateFormat;
      // 0b: aload 1
      ...
      // 16: astore 2
      // 17: aload 0
      // 18: getfield com/google/gson/DefaultDateTypeAdapter.b Ljava/text/DateFormat;
      // 1b: aload 1
   ...
   public void a(JsonWriter param1, Date param2) throws IOException {
      ...
      // 09: return
      // 0a: aload 0
      // 0b: getfield com/google/gson/DefaultDateTypeAdapter.c Ljava/text/DateFormat;
      // 0e: astore 3
      // 0f: aload 3
      // 10: monitorenter
      // 11: aload 1
      // 12: aload 0
      // 13: getfield com/google/gson/DefaultDateTypeAdapter.b Ljava/text/DateFormat;
      // 16: aload 2
   ...
   public String toString() {
      ...
      var1.append("DefaultDateTypeAdapter");
      var1.append('(').append(this.c.getClass().getSimpleName()).append(')');
