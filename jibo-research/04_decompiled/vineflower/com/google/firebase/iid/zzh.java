...
public final class zzh implements ServiceConnection {
   ...
   private final Queue<zzd> d = new ArrayDeque<>();
   private zzf e;
   ...
   private final void a() {
      ...
      // 12: pop
      // 13: aload 0
      // 14: getfield com/google/firebase/iid/zzh.d Ljava/util/Queue;
      ...
      // 2f: pop
      // 30: aload 0
      // 31: getfield com/google/firebase/iid/zzh.e Lcom/google/firebase/iid/zzf;
      // 34: ifnull 6f
      // 37: aload 0
      // 38: getfield com/google/firebase/iid/zzh.e Lcom/google/firebase/iid/zzf;
      // 3b: invokevirtual com/google/firebase/iid/zzf.isBinderAlive ()Z
      // 3e: ifeq 6f
      ...
      // 51: pop
      // 52: aload 0
      // 53: getfield com/google/firebase/iid/zzh.d Ljava/util/Queue;
      // 56: invokeinterface java/util/Queue.poll ()Ljava/lang/Object; 1
      // 5b: checkcast com/google/firebase/iid/zzd
      // 5e: astore 2
      // 5f: aload 0
      // 60: getfield com/google/firebase/iid/zzh.e Lcom/google/firebase/iid/zzf;
      // 63: aload 2
      // 64: invokevirtual com/google/firebase/iid/zzf.a (Lcom/google/firebase/iid/zzd;)V
      // 67: goto 13
      // 6a: astore 2
      // 6b: aload 0
      // 6c: monitorexit
      ...
      // 75: ifeq 9e
      // 78: aload 0
      // 79: getfield com/google/firebase/iid/zzh.f Z
      // 7c: ifne c3
      // 7f: bipush 1
      // 80: istore 1
      ...
      // 9d: pop
      // 9e: aload 0
      // 9f: getfield com/google/firebase/iid/zzh.f Z
      // a2: ifne c0
      // a5: aload 0
      // a6: bipush 1
      // a7: putfield com/google/firebase/iid/zzh.f Z
      // aa: invokestatic com/google/android/gms/common/stats/zza.a ()Lcom/google/android/gms/common/stats/zza;
      // ad: aload 0
      // ae: getfield com/google/firebase/iid/zzh.a Landroid/content/Context;
      // b1: aload 0
      // b2: getfield com/google/firebase/iid/zzh.b Landroid/content/Intent;
      // b5: aload 0
      // b6: bipush 65
      ...
      // cf: pop
      // d0: aload 0
      // d1: getfield com/google/firebase/iid/zzh.d Ljava/util/Queue;
      // d4: invokeinterface java/util/Queue.isEmpty ()Z 1
      // d9: ifne c0
      // dc: aload 0
      // dd: getfield com/google/firebase/iid/zzh.d Ljava/util/Queue;
      // e0: invokeinterface java/util/Queue.poll ()Ljava/lang/Object; 1
      // e5: checkcast com/google/firebase/iid/zzd
      // e8: invokevirtual com/google/firebase/iid/zzd.a ()V
      // eb: goto d0
      // ee: astore 2
   ...
   public final void a(Intent var1, PendingResult var2) {
      synchronized (this) {
         ...
         Queue var4 = this.d;
         zzd var3 = new zzd(var1, var2, this.c);
         var4.add(var3);
         this.a();
      }
   }
   ...
   public final void onServiceConnected(ComponentName param1, IBinder param2) {
      ...
      // 02: aload 0
      // 03: bipush 0
      // 04: putfield com/google/firebase/iid/zzh.f Z
      // 07: aload 0
      // 08: aload 2
      // 09: checkcast com/google/firebase/iid/zzf
      // 0c: putfield com/google/firebase/iid/zzh.e Lcom/google/firebase/iid/zzf;
      ...
      // 43: pop
      // 44: aload 0
      // 45: invokespecial com/google/firebase/iid/zzh.a ()V
      // 48: aload 0
      // 49: monitorexit
      // 4a: return
      // 4b: astore 1
