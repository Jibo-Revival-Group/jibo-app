...
public abstract class AbstractGoogleClient {
   ...
   static String normalizeRootUrl(String var0) {
      ...
      String var1 = var0;
      if (!var0.endsWith("/")) {
         var1 = String.valueOf(var0).concat("/");
      }
   ...
   static String normalizeServicePath(String var0) {
      ...
      if (var0.length() == 1) {
         ...
         if (var0.length() > 0) {
            String var2 = var0;
            if (!var0.endsWith("/")) {
               var2 = String.valueOf(var0).concat("/");
            }
   ...
   public final BatchRequest batch(HttpRequestInitializer var1) {
      BatchRequest var2 = new BatchRequest(this.getRequestFactory().getTransport(), var1);
      String var4 = String.valueOf(this.getRootUrl());
      String var3 = String.valueOf(this.batchPath);
      String var5;
      if (var3.length() != 0) {
         var5 = var4.concat(var3);
      } else {
         var5 = new String(var4);
      }

      var2.setBatchUrl(new GenericUrl(var5));
      return var2;
   }
   ...
   public final String getBaseUrl() {
      String var1 = String.valueOf(this.rootUrl);
      String var2 = String.valueOf(this.servicePath);
      if (var2.length() != 0) {
