...
public class GoogleAuthorizationCodeFlow extends AuthorizationCodeFlow {
   ...
   public GoogleAuthorizationCodeRequestUrl newAuthorizationUrl() {
      return new GoogleAuthorizationCodeRequestUrl(this.getAuthorizationServerEncodedUrl(), this.getClientId(), "", this.getScopes())
         .setAccessType(this.accessType)
         .setApprovalPrompt(this.approvalPrompt);
   }

   public GoogleAuthorizationCodeTokenRequest newTokenRequest(String var1) {
      return new GoogleAuthorizationCodeTokenRequest(this.getTransport(), this.getJsonFactory(), this.getTokenServerEncodedUrl(), "", "", var1, "")
   ...
   public static class Builder extends AuthorizationCodeFlow.Builder {
      ...
      public Builder(HttpTransport var1, JsonFactory var2, GoogleClientSecrets var3, Collection<String> var4) {
         super(
            ...
            new ClientParametersAuthentication(var3.getDetails().getClientId(), var3.getDetails().getClientSecret()),
            var3.getDetails().getClientId(),
      ...
      public Builder(HttpTransport var1, JsonFactory var2, String var3, String var4, Collection<String> var5) {
         super(
            ...
            var2,
            new GenericUrl("https://accounts.google.com/o/oauth2/token"),
            new ClientParametersAuthentication(var3, var4),
            var3,
            "https://accounts.google.com/o/oauth2/auth"
         );
         this.setScopes(var5);
