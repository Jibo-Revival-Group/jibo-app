...
public abstract class AbstractNotification {
   ...
   public AbstractNotification setChannelId(String var1) {
      this.channelId = Preconditions.checkNotNull(var1);
      return this;
   }
   ...
   public AbstractNotification setResourceId(String var1) {
      this.resourceId = Preconditions.checkNotNull(var1);
      return this;
   }

   public AbstractNotification setResourceState(String var1) {
      this.resourceState = Preconditions.checkNotNull(var1);
      return this;
   }

   public AbstractNotification setResourceUri(String var1) {
      this.resourceUri = Preconditions.checkNotNull(var1);
      return this;
   }
   ...
   protected Objects.ToStringHelper toStringHelper() {
      return Objects.toStringHelper(this)
         .add("messageNumber", this.messageNumber)
         .add("resourceState", this.resourceState)
         .add("resourceId", this.resourceId)
         .add("resourceUri", this.resourceUri)
         .add("channelId", this.channelId)
         .add("channelExpiration", this.channelExpiration)
         .add("channelToken", this.channelToken)
         .add("changed", this.changed);
   }
}
