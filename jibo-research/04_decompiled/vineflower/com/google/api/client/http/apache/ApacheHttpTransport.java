...
public final class ApacheHttpTransport extends HttpTransport {
   ...
   public ApacheHttpTransport(HttpClient var1) {
      ...
      HttpProtocolParams.setVersion(var2, HttpVersion.HTTP_1_1);
      var2.setBooleanParameter("http.protocol.handle-redirects", false);
   }
   ...
   public static final class Builder {
      ...
      public ApacheHttpTransport.Builder setSocketFactory(SSLSocketFactory var1) {
         this.socketFactory = Preconditions.checkNotNull(var1);
         return this;
      }
