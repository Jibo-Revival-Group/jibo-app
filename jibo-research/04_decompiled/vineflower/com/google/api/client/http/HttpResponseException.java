...
public class HttpResponseException extends IOException {
   ...
   public static class Builder {
      ...
      public Builder(HttpResponse var1) {
         ...
         try {
            this.content = var1.parseAsString();
         ...
         StringBuilder var4 = HttpResponseException.computeMessageBuffer(var1);
         if (this.content != null) {
            var4.append(StringUtils.LINE_SEPARATOR).append(this.content);
         }
