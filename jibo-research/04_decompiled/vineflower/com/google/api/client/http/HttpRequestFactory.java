...
public final class HttpRequestFactory {
   ...
   public HttpRequest buildRequest(String var1, GenericUrl var2, HttpContent var3) throws IOException {
      ...
      if (this.initializer != null) {
         this.initializer.initialize(var4);
      }
