...
public class RobotRequest extends JiboRobotPropertiesRequest {
   ...
   public RobotRequest(Robot var1) {
      this.id = var1.getId();
      this.guid = var1.getGuid();
      this.payload = var1.getPayload();
      this.created = var1.getCreatedMilliseconds();
      this.updated = var1.getUpdatedMilliseconds();
   }

   public RobotRequest(String var1, String var2, JsonObject var3, long var4, long var6) {
      Object var8 = null;
      super();
      this.id = var1;
      this.guid = var2;
