...
public class CustomFontTextView extends TextView {
   ...
   public CustomFontTextView(Context var1) {
      super(var1);
   }

   public CustomFontTextView(Context var1, AttributeSet var2) {
      super(var1, var2);
      this.a(var1, var2);
   }

   public CustomFontTextView(Context var1, AttributeSet var2, int var3) {
