...
public class LoopPassphraseSetDialog_ViewBinding extends LoopPassphraseBaseDialog_ViewBinding {
   private LoopPassphraseSetDialog b;
   private View c;
   private View d;

   public LoopPassphraseSetDialog_ViewBinding(LoopPassphraseSetDialog var1, View var2) {
      super(var1, var2);
      this.b = var1;
      View var3 = Utils.a(var2, 2131296397, "method 'onSetClicked'");
      this.c = var3;
      var3.setOnClickListener(new DebouncingOnClickListener(this, var1) {
         final LoopPassphraseSetDialog b;
         final LoopPassphraseSetDialog_ViewBinding c;
