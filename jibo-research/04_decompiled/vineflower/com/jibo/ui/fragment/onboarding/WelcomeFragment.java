...
public class WelcomeFragment extends BaseFragment {
   public static final String a = WelcomeFragment.class.getSimpleName();
   @BindView
   TextView btnLogin;
   @BindView
   Button btnSignUp;
   ...
   public View onCreateView(LayoutInflater var1, ViewGroup var2, Bundle var3) {
      return var1.inflate(2131427478, var2, false);
   }
   ...
   public void onViewCreated(View var1, Bundle var2) {
      ...
      this.btnLogin.setText(Html.fromHtml(this.getString(2131755895)));
   }
