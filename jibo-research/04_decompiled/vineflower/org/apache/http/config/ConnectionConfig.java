...
public class ConnectionConfig implements Cloneable {
   ...
   public static ConnectionConfig.Builder copy(ConnectionConfig var0) {
      ...
      return new ConnectionConfig.Builder()
         .setCharset(var0.getCharset())
         .setMalformedInputAction(var0.getMalformedInputAction())
         .setUnmappableInputAction(var0.getUnmappableInputAction())
         .setMessageConstraints(var0.getMessageConstraints());
   }
