...
public class ResponseContent implements HttpResponseInterceptor {
   ...
   public void process(HttpResponse var1, HttpContext var2) throws HttpException, IOException {
      ...
      if (var7 != null) {
         long var4 = var7.getContentLength();
         if (var7.isChunked() && !var6.lessEquals(HttpVersion.HTTP_1_0)) {
            var1.addHeader("Transfer-Encoding", "chunked");
         } else if (var4 >= 0L) {
            var1.addHeader("Content-Length", Long.toString(var7.getContentLength()));
         }

         if (var7.getContentType() != null && !var1.containsHeader("Content-Type")) {
            var1.addHeader(var7.getContentType());
         }

         if (var7.getContentEncoding() != null && !var1.containsHeader("Content-Encoding")) {
            var1.addHeader(var7.getContentEncoding());
         }
      } else {
