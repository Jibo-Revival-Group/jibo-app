...
public final class HttpProtocolParams implements CoreProtocolPNames {
   ...
   public static CodingErrorAction getMalformedInputAction(HttpParams var0) {
      Args.notNull(var0, "HTTP parameters");
      CodingErrorAction var1 = (CodingErrorAction)var0.getParameter("http.malformed.input.action");
      if (var1 == null) {
         var1 = CodingErrorAction.REPORT;
      } else {
         var1 = var1;
      }
   ...
   public static CodingErrorAction getUnmappableInputAction(HttpParams var0) {
      Args.notNull(var0, "HTTP parameters");
      CodingErrorAction var1 = (CodingErrorAction)var0.getParameter("http.unmappable.input.action");
      if (var1 == null) {
         var1 = CodingErrorAction.REPORT;
      } else {
         var1 = var1;
   ...
   public static ProtocolVersion getVersion(HttpParams var0) {
      Args.notNull(var0, "HTTP parameters");
      ProtocolVersion var1 = (ProtocolVersion)var0.getParameter("http.protocol.version");
      if (var1 == null) {
