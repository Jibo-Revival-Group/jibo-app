...
public class MultipartEntityBuilder {
   ...
   private String generateBoundary() {
      ...
      int var2 = var3.nextInt(11);

      for (int var1 = 0; var1 < var2 + 30; var1++) {
         var4.append(MULTIPART_CHARS[var3.nextInt(MULTIPART_CHARS.length)]);
      }
   ...
   public MultipartEntityBuilder addBinaryBody(String var1, File var2) {
      return this.addBinaryBody(var1, var2, ContentType.DEFAULT_BINARY, null);
   }
   ...
   MultipartFormEntity buildEntity() {
      ...
      AbstractMultipartForm var6;
      switch (<unrepresentable>.$SwitchMap$org$apache$http$entity$mime$HttpMultipartMode[var4.ordinal()]) {
         case 1:
            var6 = new HttpBrowserCompatibleMultipart(var1, var5, var2, var3);
            break;
         case 2:
            var6 = new HttpRFC6532Multipart(var1, var5, var2, var3);
            break;
         default:
            var6 = new HttpStrictMultipart(var1, var5, var2, var3);
      }

      return new MultipartFormEntity(var6, this.generateContentType(var2, var5), var6.getTotalLength());
   }
