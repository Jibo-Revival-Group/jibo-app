...
public class DefaultBHttpServerConnection extends BHttpConnectionBase implements HttpServerConnection {
   ...
   public DefaultBHttpServerConnection(
      ...
      HttpMessageParserFactory<HttpRequest> var8,
      HttpMessageWriterFactory<HttpResponse> var9
   ) {
      if (var6 == null) {
      ...
      this.requestParser = var8.create(this.getSessionInputBuffer(), var5);
      if (var9 == null) {
         var9 = DefaultHttpResponseWriterFactory.INSTANCE;
      }

      this.responseWriter = var9.create(this.getSessionOutputBuffer());
   }
