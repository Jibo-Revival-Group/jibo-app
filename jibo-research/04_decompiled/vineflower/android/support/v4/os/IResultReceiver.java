...
public interface IResultReceiver extends IInterface {
   ...
   abstract class Stub extends Binder implements IResultReceiver {
      ...
      public static IResultReceiver a(IBinder var0) {
         IResultReceiver var2;
         if (var0 == null) {
            var2 = null;
         } else {
      ...
      private static class Proxy implements IResultReceiver {
         ...
         public void a(int param1, Bundle param2) throws RemoteException {
            ...
            // 03: astore 3
            // 04: aload 3
            // 05: ldc "android.support.v4.os.IResultReceiver"
            ...
            // 1e: aload 0
            // 1f: getfield android/support/v4/os/IResultReceiver$Stub$Proxy.a Landroid/os/IBinder;
            // 22: bipush 1
            // 23: aload 3
            // 24: aconst_null
            // 25: bipush 1
