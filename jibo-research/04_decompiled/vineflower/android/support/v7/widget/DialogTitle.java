   ...
   protected void onMeasure(int var1, int var2) {
      ...
      if (var4 != null) {
         ...
         if (var3 > 0 && var4.getEllipsisCount(var3 - 1) > 0) {
            ...
            this.setMaxLines(2);
            TypedArray var6 = this.getContext().obtainStyledAttributes(null, R.styleable.TextAppearance, 16842817, 16973892);
            var3 = var6.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, 0);
            if (var3 != 0) {
               this.setTextSize(0, var3);
            }
