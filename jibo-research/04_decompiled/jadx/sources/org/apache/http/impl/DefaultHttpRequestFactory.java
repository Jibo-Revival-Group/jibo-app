...
public class DefaultHttpRequestFactory implements HttpRequestFactory {
    ...
    private static final String[] RFC2616_COMMON_METHODS = {HttpMethods.GET};
    private static final String[] RFC2616_ENTITY_ENC_METHODS = {HttpMethods.POST, HttpMethods.PUT};
    private static final String[] RFC2616_SPECIAL_METHODS = {HttpMethods.HEAD, HttpMethods.OPTIONS, HttpMethods.DELETE, HttpMethods.TRACE, HttpMethods.CONNECT};
