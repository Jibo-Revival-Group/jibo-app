...
class ISOYearOfEraDateTimeField extends DecoratedDateTimeField {
    ...
    static final DateTimeField f15953a = new ISOYearOfEraDateTimeField();

    private ISOYearOfEraDateTimeField() {
        super(GregorianChronology.m16703Z().mo16395E(), DateTimeFieldType.m16505t());
    }

    @Override // org.joda.time.field.DecoratedDateTimeField, org.joda.time.DateTimeField
    /* JADX INFO: renamed from: e */
    public DurationField mo16455e() {
        return GregorianChronology.m16703Z().mo16400J();
    }
    ...
    public int mo16434a(long j) {
        ...
        return iMo16434a < 0 ? -iMo16434a : iMo16434a;
    }
    ...
    public long mo16443b(long j, int i) {
        FieldUtils.m16755a(this, i, 0, mo16460h());
        if (m16748i().mo16434a(j) < 0) {
            i = -i;
        }
