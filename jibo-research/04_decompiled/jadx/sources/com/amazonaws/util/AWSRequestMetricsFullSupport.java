...
public class AWSRequestMetricsFullSupport extends AWSRequestMetrics {
    ...
    public static final String TAG = C0977a.m10070a(AWSRequestMetricsFullSupport.class);
    ...
    private void keyValueFormat(Object obj, Object obj2, StringBuilder sb) {
        sb.append(obj).append(KEY_VALUE_SEPARATOR).append(obj2).append(COMMA_SEPARATOR);
    }
    ...
    public void endEvent(String str) {
        ...
        if (timingInfo == null) {
            C0977a.m10076c(TAG, "Trying to end an event which was never started: " + str);
        } else {
    ...
    public void log() {
        ...
        C0977a.m10074b(TAG, sb.toString());
    }
