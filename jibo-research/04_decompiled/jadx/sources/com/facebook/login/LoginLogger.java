...
class LoginLogger {
    ...
    public void logStartLogin(LoginClient.Request request) {
        ...
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_START, null, bundleNewAuthorizationLoggingBundle);
    }
    ...
    public void logCompleteLogin(String str, Map<String, String> map, LoginClient.Result.Code code, Map<String, String> map2, Exception exc) {
        ...
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_COMPLETE, null, bundleNewAuthorizationLoggingBundle);
    }
    ...
    public void logAuthorizationMethodStart(String str, String str2) {
        ...
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_METHOD_START, null, bundleNewAuthorizationLoggingBundle);
    }
    ...
    public void logAuthorizationMethodComplete(String str, String str2, String str3, String str4, String str5, Map<String, String> map) {
        ...
        bundleNewAuthorizationLoggingBundle.putString(EVENT_PARAM_METHOD, str2);
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_METHOD_COMPLETE, null, bundleNewAuthorizationLoggingBundle);
    }

    public void logAuthorizationMethodNotTried(String str, String str2) {
        Bundle bundleNewAuthorizationLoggingBundle = newAuthorizationLoggingBundle(str);
        bundleNewAuthorizationLoggingBundle.putString(EVENT_PARAM_METHOD, str2);
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_METHOD_NOT_TRIED, null, bundleNewAuthorizationLoggingBundle);
    }
    ...
    public void logUnexpectedError(String str, String str2, String str3) {
        ...
        this.appEventsLogger.logSdkEvent(str, null, bundleNewAuthorizationLoggingBundle);
    }
}
