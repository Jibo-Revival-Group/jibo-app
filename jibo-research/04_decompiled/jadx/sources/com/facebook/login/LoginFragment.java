...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        final View viewInflate = layoutInflater.inflate(C0444R.layout.com_facebook_login_fragment, viewGroup, false);
        this.loginClient.setBackgroundProcessingListener(new LoginClient.BackgroundProcessingListener() { // from class: com.facebook.login.LoginFragment.2
            ...
            public void onBackgroundProcessingStarted() {
                viewInflate.findViewById(C0444R.id.com_facebook_login_activity_progress_bar).setVisibility(0);
            }

            @Override // com.facebook.login.LoginClient.BackgroundProcessingListener
            public void onBackgroundProcessingStopped() {
                viewInflate.findViewById(C0444R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
            }
        });
        return viewInflate;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(C0444R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
    }
