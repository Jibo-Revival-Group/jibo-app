...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0444R.styleable.com_facebook_profile_picture_view);
        setPresetSize(typedArrayObtainStyledAttributes.getInt(C0444R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
        this.isCropped = typedArrayObtainStyledAttributes.getBoolean(C0444R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
    ...
    private void setBlankProfilePicture() {
        ...
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C0444R.drawable.com_facebook_profile_picture_blank_square : C0444R.drawable.com_facebook_profile_picture_blank_portrait));
        } else {
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        switch (this.presetSizeType) {
            case LARGE /* -4 */:
                i = C0444R.dimen.com_facebook_profilepictureview_preset_size_large;
                break;
            case NORMAL /* -3 */:
                i = C0444R.dimen.com_facebook_profilepictureview_preset_size_normal;
                break;
            case -2:
                i = C0444R.dimen.com_facebook_profilepictureview_preset_size_small;
                break;
            case -1:
                if (!z) {
                    return 0;
