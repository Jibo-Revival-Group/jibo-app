...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        this.dialog = new Dialog(getActivity(), C0444R.style.com_facebook_auth_dialog);
    ...
    public View initializeContentView(boolean z) {
        ...
        if (z) {
            viewInflate = layoutInflater.inflate(C0444R.layout.com_facebook_smart_device_dialog_fragment, (ViewGroup) null);
        } else {
            viewInflate = layoutInflater.inflate(C0444R.layout.com_facebook_device_auth_dialog_fragment, (ViewGroup) null);
        }
        this.progressBar = (ProgressBar) viewInflate.findViewById(C0444R.id.progress_bar);
        this.confirmationCode = (TextView) viewInflate.findViewById(C0444R.id.confirmation_code);
        ((Button) viewInflate.findViewById(C0444R.id.cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.login.DeviceAuthDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DeviceAuthDialog.this.onCancel();
            }
        });
        ((TextView) viewInflate.findViewById(C0444R.id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C0444R.string.com_facebook_device_auth_instructions)));
        return viewInflate;
    }
    ...
    public void presentConfirmation(final String str, final Utility.PermissionsPair permissionsPair, final String str2, String str3) {
        String string = getResources().getString(C0444R.string.com_facebook_smart_login_confirmation_title);
        String string2 = getResources().getString(C0444R.string.com_facebook_smart_login_confirmation_continue_as);
        String string3 = getResources().getString(C0444R.string.com_facebook_smart_login_confirmation_cancel);
