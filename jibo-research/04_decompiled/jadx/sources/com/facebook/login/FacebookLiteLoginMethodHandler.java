...
class FacebookLiteLoginMethodHandler extends NativeAppLoginMethodHandler {
    ...
    boolean tryAuthorize(LoginClient.Request request) {
        ...
        Intent intentCreateFacebookLiteIntent = NativeProtocol.createFacebookLiteIntent(this.loginClient.getActivity(), request.getApplicationId(), request.getPermissions(), e2e, request.isRerequest(), request.hasPublishPermission(), request.getDefaultAudience(), getClientState(request.getAuthId()));
