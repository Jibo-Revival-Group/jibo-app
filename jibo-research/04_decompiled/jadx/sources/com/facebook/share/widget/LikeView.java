...
public class LikeView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet != null && getContext() != null && (typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0444R.styleable.com_facebook_like_view)) != null) {
            this.objectId = Utility.coerceValueIfNullOrEmpty(typedArrayObtainStyledAttributes.getString(C0444R.styleable.com_facebook_like_view_com_facebook_object_id), null);
            this.objectType = ObjectType.fromInt(typedArrayObtainStyledAttributes.getInt(C0444R.styleable.com_facebook_like_view_com_facebook_object_type, ObjectType.DEFAULT.getValue()));
            this.likeViewStyle = Style.fromInt(typedArrayObtainStyledAttributes.getInt(C0444R.styleable.com_facebook_like_view_com_facebook_style, Style.DEFAULT.getValue()));
            if (this.likeViewStyle == null) {
                throw new IllegalArgumentException("Unsupported value for LikeView 'style'");
            }
            this.auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(typedArrayObtainStyledAttributes.getInt(C0444R.styleable.com_facebook_like_view_com_facebook_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
            if (this.auxiliaryViewPosition == null) {
                throw new IllegalArgumentException("Unsupported value for LikeView 'auxiliary_view_position'");
            }
            this.horizontalAlignment = HorizontalAlignment.fromInt(typedArrayObtainStyledAttributes.getInt(C0444R.styleable.com_facebook_like_view_com_facebook_horizontal_alignment, HorizontalAlignment.DEFAULT.getValue()));
            if (this.horizontalAlignment == null) {
                throw new IllegalArgumentException("Unsupported value for LikeView 'horizontal_alignment'");
            }
            this.foregroundColor = typedArrayObtainStyledAttributes.getColor(C0444R.styleable.com_facebook_like_view_com_facebook_foreground_color, -1);
            typedArrayObtainStyledAttributes.recycle();
        }
    }

    private void initialize(Context context) {
        this.edgePadding = getResources().getDimensionPixelSize(C0444R.dimen.com_facebook_likeview_edge_padding);
        this.internalPadding = getResources().getDimensionPixelSize(C0444R.dimen.com_facebook_likeview_internal_padding);
        if (this.foregroundColor == -1) {
            this.foregroundColor = getResources().getColor(C0444R.color.com_facebook_likeview_text_color);
        }
    ...
    private void initializeSocialSentenceView(Context context) {
        ...
        this.socialSentenceView.setTextSize(0, getResources().getDimension(C0444R.dimen.com_facebook_likeview_text_size));
    ...
    public void associateWithLikeActionController(LikeActionController likeActionController) {
        ...
        LocalBroadcastManager localBroadcastManagerM1878a = LocalBroadcastManager.m1878a(getContext());
        ...
        localBroadcastManagerM1878a.m1882a(this.broadcastReceiver, intentFilter);
    }

    private void tearDownObjectAssociations() {
        if (this.broadcastReceiver != null) {
            LocalBroadcastManager.m1878a(getContext()).m1881a(this.broadcastReceiver);
