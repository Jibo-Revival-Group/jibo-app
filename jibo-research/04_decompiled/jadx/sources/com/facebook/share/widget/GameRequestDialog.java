...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        private Result(Bundle bundle) {
            ...
            this.f5387to = new ArrayList();
            while (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, Integer.valueOf(this.f5387to.size())))) {
                this.f5387to.add(bundle.getString(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, Integer.valueOf(this.f5387to.size()))));
            }
        }
