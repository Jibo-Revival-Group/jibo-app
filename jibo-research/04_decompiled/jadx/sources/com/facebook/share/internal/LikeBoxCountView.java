...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initialize(Context context) {
        ...
        this.caretHeight = getResources().getDimension(C0444R.dimen.com_facebook_likeboxcountview_caret_height);
        this.caretWidth = getResources().getDimension(C0444R.dimen.com_facebook_likeboxcountview_caret_width);
        this.borderRadius = getResources().getDimension(C0444R.dimen.com_facebook_likeboxcountview_border_radius);
        this.borderPaint = new Paint();
        this.borderPaint.setColor(getResources().getColor(C0444R.color.com_facebook_likeboxcountview_border_color));
        this.borderPaint.setStrokeWidth(getResources().getDimension(C0444R.dimen.com_facebook_likeboxcountview_border_width));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setTextSize(0, getResources().getDimension(C0444R.dimen.com_facebook_likeboxcountview_text_size));
        this.likeCountLabel.setTextColor(getResources().getColor(C0444R.color.com_facebook_likeboxcountview_text_color));
        this.textPadding = getResources().getDimensionPixelSize(C0444R.dimen.com_facebook_likeboxcountview_text_padding);
        this.additionalTextPadding = getResources().getDimensionPixelSize(C0444R.dimen.com_facebook_likeboxcountview_caret_height);
    }
    ...
    private void drawBorder(Canvas canvas, float f, float f2, float f3, float f4) {
        ...
        path.addArc(new RectF(f3 - f5, f4 - f5, f3, f4), CropImageView.DEFAULT_ASPECT_RATIO, 90.0f);
