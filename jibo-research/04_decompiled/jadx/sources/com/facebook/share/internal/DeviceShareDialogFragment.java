...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View viewInflate = getActivity().getLayoutInflater().inflate(C0444R.layout.com_facebook_device_auth_dialog_fragment, (ViewGroup) null);
        ...
        ((Button) viewInflate.findViewById(C0444R.id.cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.share.internal.DeviceShareDialogFragment.1
    ...
    private void detach() {
        if (isAdded()) {
            getFragmentManager().mo1471a().mo1366a(this).mo1385d();
        }
    }
