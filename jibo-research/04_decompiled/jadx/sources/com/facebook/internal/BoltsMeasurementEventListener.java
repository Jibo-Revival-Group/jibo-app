...
public class BoltsMeasurementEventListener extends BroadcastReceiver {
    ...
    private void open() {
        LocalBroadcastManager.m1878a(this.applicationContext).m1882a(this, new IntentFilter(MEASUREMENT_EVENT_NOTIFICATION_NAME));
    }

    private void close() {
        LocalBroadcastManager.m1878a(this.applicationContext).m1881a(this);
    }
