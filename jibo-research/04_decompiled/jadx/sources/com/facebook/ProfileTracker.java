...
public abstract class ProfileTracker {
    ...
    public ProfileTracker() {
        ...
        this.broadcastManager = LocalBroadcastManager.m1878a(FacebookSdk.getApplicationContext());
        startTracking();
    }
    ...
    public void stopTracking() {
        if (this.isTracking) {
            this.broadcastManager.m1881a(this.receiver);
    ...
    private void addBroadcastReceiver() {
        ...
        this.broadcastManager.m1882a(this.receiver, intentFilter);
    }
}
