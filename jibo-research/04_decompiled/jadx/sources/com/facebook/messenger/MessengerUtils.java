...
public class MessengerUtils {
    ...
    public static MessengerThreadParams getMessengerThreadParamsForIntent(Intent intent) {
        ...
        Bundle bundleM5104b = AppLinks.m5104b(intent);
        String string = bundleM5104b.getString(EXTRA_THREAD_TOKEN_KEY);
        String string2 = bundleM5104b.getString(EXTRA_METADATA);
        String string3 = bundleM5104b.getString(EXTRA_PARTICIPANTS);
        boolean z = bundleM5104b.getBoolean(EXTRA_IS_REPLY);
        boolean z2 = bundleM5104b.getBoolean(EXTRA_IS_COMPOSE);
    ...
    public static void finishShareToMessenger(Activity activity, ShareToMessengerParams shareToMessengerParams) {
        ...
        if (categories.contains(ORCA_THREAD_CATEGORY_20150314)) {
            ...
            if (categories.contains(ORCA_THREAD_CATEGORY_20150314)) {
                ...
                intent2.putExtra(EXTRA_THREAD_TOKEN_KEY, bundleM5104b.getString(EXTRA_THREAD_TOKEN_KEY));
    ...
    private static Set<Integer> getAllAvailableProtocolVersions(Context context) {
        ...
        if (cursorQuery != null) {
            try {
                int columnIndex = cursorQuery.getColumnIndex(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION);
