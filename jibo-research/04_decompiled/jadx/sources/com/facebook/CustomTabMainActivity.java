...
public class CustomTabMainActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION.equals(getIntent().getAction())) {
            ...
            LocalBroadcastManager.m1878a(this).m1882a(this.redirectReceiver, new IntentFilter(CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION));
        }
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (REFRESH_ACTION.equals(intent.getAction())) {
            LocalBroadcastManager.m1878a(this).m1883a(new Intent(CustomTabActivity.DESTROY_ACTION));
            sendResult(-1, intent);
    ...
    private void sendResult(int i, Intent intent) {
        LocalBroadcastManager.m1878a(this).m1881a(this.redirectReceiver);
        if (intent != null) {
            setResult(i, intent);
        } else {
            setResult(i);
