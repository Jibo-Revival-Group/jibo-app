...
public class CustomTabActivity extends Activity {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i2 == 0) {
            ...
            LocalBroadcastManager.m1878a(this).m1883a(intent2);
            ...
            LocalBroadcastManager.m1878a(this).m1882a(this.closeReceiver, new IntentFilter(DESTROY_ACTION));
        }
    }

    @Override // android.app.Activity
    protected void onDestroy() {
        LocalBroadcastManager.m1878a(this).m1881a(this.closeReceiver);
        super.onDestroy();
    }
}
