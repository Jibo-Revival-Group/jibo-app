...
public class RemoveMemberPhotoRequest extends JiboLoopRequest {

    /* JADX INFO: renamed from: id */
    @Expose
    private String f9568id;

    public RemoveMemberPhotoRequest(String str, String str2) {
        super(str);
        this.f9568id = str2;
    }
    ...
    public String toString() {
        return "RemoveMemberPhotoRequest {id='" + this.f9568id + "'loopId='" + this.loopId + "'}";
    }
}
