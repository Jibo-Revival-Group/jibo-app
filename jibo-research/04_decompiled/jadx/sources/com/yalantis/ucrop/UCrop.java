...
public class UCrop {
    ...
    public static UCrop m15054of(Uri uri, Uri uri2) {
    ...
    public static class Options {
        ...
        public void setOvalDimmedLayer(boolean z) {
            this.mOptionBundle.putBoolean(EXTRA_OVAL_DIMMED_LAYER, z);
        }
        ...
        public void setCropPadding(int i) {
            this.mOptionBundle.putInt(EXTRA_CROP_PADDING, i);
        }
