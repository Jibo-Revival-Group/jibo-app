...
public class AspectRatioTextView extends TextView {
    ...
    public AspectRatioTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        init(context.obtainStyledAttributes(attributeSet, C1735R.styleable.ucrop_AspectRatioTextView));
    }
    ...
    private void init(TypedArray typedArray) {
        setGravity(1);
        this.mAspectRatioTitle = typedArray.getString(C1735R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_title);
        this.mAspectRatioX = typedArray.getFloat(C1735R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_x, CropImageView.DEFAULT_ASPECT_RATIO);
        this.mAspectRatioY = typedArray.getFloat(C1735R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_y, CropImageView.DEFAULT_ASPECT_RATIO);
        if (this.mAspectRatioX == CropImageView.DEFAULT_ASPECT_RATIO || this.mAspectRatioY == CropImageView.DEFAULT_ASPECT_RATIO) {
            this.mAspectRatio = CropImageView.DEFAULT_ASPECT_RATIO;
        } else {
            this.mAspectRatio = this.mAspectRatioX / this.mAspectRatioY;
        }
        this.mDotSize = getContext().getResources().getDimensionPixelSize(C1735R.dimen.ucrop_size_dot_scale_text_view);
        this.mDotPaint = new Paint(1);
        this.mDotPaint.setStyle(Paint.Style.FILL);
        setTitle();
        applyActiveColor(getResources().getColor(C1735R.color.ucrop_color_widget_active));
        typedArray.recycle();
    }
    ...
    private void applyActiveColor(int i) {
        ...
        setTextColor(new ColorStateList(new int[][]{new int[]{R.attr.state_selected}, new int[]{0}}, new int[]{i, ContextCompat.m1840c(getContext(), C1735R.color.ucrop_color_widget)}));
    }
