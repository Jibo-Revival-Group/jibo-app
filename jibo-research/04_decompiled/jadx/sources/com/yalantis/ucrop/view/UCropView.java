...
public class UCropView extends FrameLayout {
    ...
    public UCropView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1735R.layout.ucrop_view, (ViewGroup) this, true);
        this.mGestureCropImageView = (GestureCropImageView) findViewById(C1735R.id.image_view_crop);
        this.mViewOverlay = (OverlayView) findViewById(C1735R.id.view_overlay);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1735R.styleable.ucrop_UCropView);
