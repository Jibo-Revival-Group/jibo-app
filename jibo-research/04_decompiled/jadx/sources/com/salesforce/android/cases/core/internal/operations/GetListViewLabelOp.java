...
public class GetListViewLabelOp extends CaseFetchSaveOperation<ListViewRequest, String> {
    ...
    public Async<String> mo12508a(LocalRepository localRepository, ListViewRequest listViewRequest) {
        return localRepository.mo12393b(listViewRequest);
    }
    ...
    public Async<Void> mo12509a(LocalRepository localRepository, ListViewRequest listViewRequest, String str) {
        return localRepository.mo12394b(listViewRequest, str);
    }
    ...
    public Async<String> mo12510a(RemoteRepository remoteRepository, final ListViewRequest listViewRequest) {
        return remoteRepository.m12602b().mo14076a(new Function<List<ListView>, String>() { // from class: com.salesforce.android.cases.core.internal.operations.GetListViewLabelOp.1
