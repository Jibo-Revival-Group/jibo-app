...
class AttributeStrategy implements LruPoolStrategy {
    ...
    public void put(Bitmap bitmap) {
        this.groupedMap.put(this.keyPool.m5427a(bitmap.getWidth(), bitmap.getHeight(), bitmap.getConfig()), bitmap);
    }

    @Override // com.bumptech.glide.load.engine.bitmap_recycle.LruPoolStrategy
    public Bitmap get(int i, int i2, Bitmap.Config config) {
        return this.groupedMap.get(this.keyPool.m5427a(i, i2, config));
    }
    ...
    static class KeyPool extends BaseKeyPool<Key> {
        ...
        public Key m5427a(int i, int i2, Bitmap.Config config) {
            Key key = get();
