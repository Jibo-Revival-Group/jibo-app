...
public class RecyclableBufferedInputStream extends FilterInputStream {
    ...
    private int fillbuf(InputStream inputStream, byte[] bArr) throws IOException {
        ...
        this.markpos = 0;
        this.count = 0;
        int i2 = inputStream.read(bArr, this.pos, bArr.length - this.pos);
        this.count = i2 <= 0 ? this.pos : this.pos + i2;
        return i2;
    }
    ...
    */
    public synchronized int read(byte[] r7, int r8, int r9) throws java.io.IOException {
        /*
            ...
            if (r2 != 0) goto Le
            java.io.IOException r0 = streamClosed()     // Catch: java.lang.Throwable -> Lb
        ...
        L59:
            ...
            goto L47
        L5b:
            int r1 = r6.fillbuf(r4, r2)     // Catch: java.lang.Throwable -> Lb
            if (r1 != r0) goto L66
            if (r3 == r9) goto L11
            int r0 = r9 - r3
            goto L11
