...
public final class zzbeo extends zzab<zzbes> {
    public zzbeo(Context context, Looper looper, zzr zzrVar, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
    ...
    protected final /* synthetic */ IInterface mo6768a(IBinder iBinder) {
        ...
        return iInterfaceQueryLocalInterface instanceof zzbes ? (zzbes) iInterfaceQueryLocalInterface : new zzbet(iBinder);
    }
