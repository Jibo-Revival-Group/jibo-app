...
public enum zzaxb {
    ...
    public static boolean zza(zzaxb zzaxbVar) {
        return BAD_AUTHENTICATION.equals(zzaxbVar) || CAPTCHA.equals(zzaxbVar) || NEED_PERMISSION.equals(zzaxbVar) || NEED_REMOTE_CONSENT.equals(zzaxbVar) || NEEDS_BROWSER.equals(zzaxbVar) || USER_CANCEL.equals(zzaxbVar) || DEVICE_MANAGEMENT_REQUIRED.equals(zzaxbVar) || DM_INTERNAL_ERROR.equals(zzaxbVar) || DM_SYNC_DISABLED.equals(zzaxbVar) || DM_ADMIN_BLOCKED.equals(zzaxbVar) || DM_ADMIN_PENDING_APPROVAL.equals(zzaxbVar) || DM_STALE_SYNC_REQUIRED.equals(zzaxbVar) || DM_DEACTIVATED.equals(zzaxbVar) || DM_REQUIRED.equals(zzaxbVar) || THIRD_PARTY_DEVICE_MANAGEMENT_REQUIRED.equals(zzaxbVar) || DM_SCREENLOCK_REQUIRED.equals(zzaxbVar);
    }

    public static final zzaxb zzfb(String str) {
        zzaxb zzaxbVar = null;
        zzaxb[] zzaxbVarArrValues = values();
        int length = zzaxbVarArrValues.length;
        int i = 0;
        while (i < length) {
            zzaxb zzaxbVar2 = zzaxbVarArrValues[i];
