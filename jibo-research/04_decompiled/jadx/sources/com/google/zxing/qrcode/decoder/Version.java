...
public final class Version {
    ...
    private static final int[] f9104a = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* JADX INFO: renamed from: b */
    private static final Version[] f9105b = m9700d();
    ...
    private Version(int i, int[] iArr, ECBlocks... eCBlocksArr) {
        this.f9106c = i;
        this.f9107d = iArr;
        this.f9108e = eCBlocksArr;
        int iM9707a = eCBlocksArr[0].m9707a();
        int iM9706b = 0;
        for (ECB ecb : eCBlocksArr[0].m9710d()) {
            iM9706b += (ecb.m9706b() + iM9707a) * ecb.m9705a();
        }
        this.f9109f = iM9706b;
    }
    ...
    /* JADX INFO: renamed from: c */
    public int m9704c() {
        return (this.f9106c * 4) + 17;
    }

    /* JADX INFO: renamed from: a */
    public ECBlocks m9702a(ErrorCorrectionLevel errorCorrectionLevel) {
        return this.f9108e[errorCorrectionLevel.ordinal()];
    }

    /* JADX INFO: renamed from: a */
    public static Version m9699a(int i) {
        if (i < 1 || i > 40) {
    ...
    public String toString() {
        return String.valueOf(this.f9106c);
    }

    /* JADX INFO: renamed from: d */
    private static Version[] m9700d() {
