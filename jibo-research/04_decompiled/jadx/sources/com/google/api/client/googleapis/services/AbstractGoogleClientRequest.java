...
public abstract class AbstractGoogleClientRequest<T> extends GenericData {
    ...
    protected AbstractGoogleClientRequest(AbstractGoogleClient abstractGoogleClient, String str, String str2, HttpContent httpContent, Class<T> cls) {
        ...
        if (applicationName != null) {
            ...
            String strValueOf = String.valueOf(String.valueOf(applicationName));
            String strValueOf2 = String.valueOf(String.valueOf(USER_AGENT_SUFFIX));
            httpHeaders.setUserAgent(new StringBuilder(strValueOf.length() + 1 + strValueOf2.length()).append(strValueOf).append(" ").append(strValueOf2).toString());
            return;
        }
