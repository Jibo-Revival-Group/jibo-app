...
public final class StoredChannel implements Serializable {
    ...
    public StoredChannel(UnparsedNotificationCallback unparsedNotificationCallback, String str) {
        ...
        this.f8436id = (String) Preconditions.checkNotNull(str);
    }
    ...
    public String toString() {
        return Objects.toStringHelper(StoredChannel.class).add("notificationCallback", getNotificationCallback()).add("clientToken", getClientToken()).add("expiration", getExpiration()).add(ShareConstants.WEB_DIALOG_PARAM_ID, getId()).add("topicId", getTopicId()).toString();
    }
