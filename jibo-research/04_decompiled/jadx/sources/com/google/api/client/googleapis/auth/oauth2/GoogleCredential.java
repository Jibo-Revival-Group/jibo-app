...
public class GoogleCredential extends Credential {
    ...
    public static GoogleCredential fromStream(InputStream inputStream, HttpTransport httpTransport, JsonFactory jsonFactory) throws IOException {
        ...
        String str = (String) genericJson.get(ShareConstants.MEDIA_TYPE);
        if (str == null) {
    ...
    protected TokenResponse executeRefreshToken() throws IOException {
        ...
        payload.setIssuedAtTimeSeconds(Long.valueOf(jCurrentTimeMillis / 1000));
        payload.setExpirationTimeSeconds(Long.valueOf((jCurrentTimeMillis / 1000) + 3600));
        payload.setSubject(this.serviceAccountUser);
        payload.put("scope", (Object) Joiner.m8980on(TokenParser.f15715SP).join(this.serviceAccountScopes));
        try {
    ...
    public final String getServiceAccountScopesAsString() {
        ...
        return Joiner.m8980on(TokenParser.f15715SP).join(this.serviceAccountScopes);
    }
