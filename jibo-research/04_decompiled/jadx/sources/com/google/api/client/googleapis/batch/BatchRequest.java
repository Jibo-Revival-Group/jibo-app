...
public final class BatchRequest {
    ...
    public void execute() throws IOException {
        ...
        do {
            ...
            try {
                String strValueOf = String.valueOf(httpResponseExecute.getMediaType().getParameter("boundary"));
                BatchUnparsedResponse batchUnparsedResponse = new BatchUnparsedResponse(httpResponseExecute.getContent(), strValueOf.length() != 0 ? "--".concat(strValueOf) : new String("--"), this.requestInfos, z);
