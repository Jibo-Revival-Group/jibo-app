...
final class DataMap extends AbstractMap<String, Object> {
    ...
    DataMap(Object obj, boolean z) {
        this.object = obj;
        this.classInfo = ClassInfo.m8977of(obj.getClass(), z);
    ...
    public Object put(String str, Object obj) {
        ...
        Preconditions.checkNotNull(fieldInfo, strValueOf.length() != 0 ? "no field of key ".concat(strValueOf) : new String("no field of key "));
