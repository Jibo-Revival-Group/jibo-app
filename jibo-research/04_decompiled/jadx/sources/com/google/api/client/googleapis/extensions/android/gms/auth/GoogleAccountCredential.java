...
public class GoogleAccountCredential implements HttpRequestInitializer {
    ...
    public static GoogleAccountCredential usingOAuth2(Context context, Collection<String> collection) {
        ...
        String strValueOf = String.valueOf(Joiner.m8980on(TokenParser.f15715SP).join(collection));
    ...
    public final Intent newChooseAccountIntent() {
        return AccountPicker.m6818a(this.selectedAccount, null, new String[]{GoogleAccountManager.ACCOUNT_TYPE}, true, null, null, null, null);
    }
    ...
    public String getToken() throws IOException, GoogleAuthException {
        ...
        while (true) {
            try {
                return GoogleAuthUtil.m6668a(this.context, this.accountName, this.scope);
            } catch (IOException e) {
    ...
    class RequestHandler implements HttpExecuteInterceptor, HttpUnsuccessfulResponseHandler {
        ...
        public boolean handleResponse(HttpRequest httpRequest, HttpResponse httpResponse, boolean z) {
            ...
            GoogleAuthUtil.m6669a(GoogleAccountCredential.this.context, this.token);
            return true;
        }
    }
}
