...
public abstract class AbstractGoogleClient {
    ...
    public final String getBaseUrl() {
        String strValueOf = String.valueOf(this.rootUrl);
        String strValueOf2 = String.valueOf(this.servicePath);
    ...
    public final BatchRequest batch(HttpRequestInitializer httpRequestInitializer) {
        ...
        String strValueOf = String.valueOf(getRootUrl());
        String strValueOf2 = String.valueOf(this.batchPath);
        batchRequest.setBatchUrl(new GenericUrl(strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf)));
        return batchRequest;
    }
