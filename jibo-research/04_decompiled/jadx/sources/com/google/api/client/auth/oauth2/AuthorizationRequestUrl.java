...
public class AuthorizationRequestUrl extends GenericUrl {
    ...
    public AuthorizationRequestUrl setResponseTypes(Collection<String> collection) {
        this.responseTypes = Joiner.m8980on(TokenParser.f15715SP).join(collection);
        return this;
    }
    ...
    public AuthorizationRequestUrl setScopes(Collection<String> collection) {
        this.scopes = (collection == null || !collection.iterator().hasNext()) ? null : Joiner.m8980on(TokenParser.f15715SP).join(collection);
        return this;
    }
