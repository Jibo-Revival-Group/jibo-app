...
public class JsonWebSignature extends JsonWebToken {
    ...
    public static String signUsingRsaSha256(PrivateKey privateKey, JsonFactory jsonFactory, Header header, JsonWebToken.Payload payload) throws GeneralSecurityException, IOException {
        ...
        String string = new StringBuilder(strValueOf.length() + 1 + strValueOf2.length()).append(strValueOf).append(FileUtils.HIDDEN_PREFIX).append(strValueOf2).toString();
        ...
        return new StringBuilder(strValueOf3.length() + 1 + strValueOf4.length()).append(strValueOf3).append(FileUtils.HIDDEN_PREFIX).append(strValueOf4).toString();
    }
}
