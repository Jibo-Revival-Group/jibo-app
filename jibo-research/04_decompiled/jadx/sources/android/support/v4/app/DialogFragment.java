...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public void show(FragmentManager fragmentManager, String str) {
        ...
        FragmentTransaction fragmentTransactionMo1471a = fragmentManager.mo1471a();
        fragmentTransactionMo1471a.mo1367a(this, str);
    ...
    public int show(FragmentTransaction fragmentTransaction, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        fragmentTransaction.mo1367a(this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = fragmentTransaction.mo1385d();
    ...
    public void showNow(FragmentManager fragmentManager, String str) {
        ...
        FragmentTransaction fragmentTransactionMo1471a = fragmentManager.mo1471a();
        fragmentTransactionMo1471a.mo1367a(this, str);
        fragmentTransactionMo1471a.mo1387f();
    }
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo1472a(this.mBackStackId, 1);
                this.mBackStackId = -1;
                return;
            }
            FragmentTransaction fragmentTransactionMo1471a = getFragmentManager().mo1471a();
            fragmentTransactionMo1471a.mo1366a(this);
            if (z) {
                fragmentTransactionMo1471a.mo1386e();
            } else {
                fragmentTransactionMo1471a.mo1385d();
            }
        }
    ...
    public LayoutInflater onGetLayoutInflater(Bundle bundle) {
        ...
        return (LayoutInflater) this.mHost.m1464i().getSystemService("layout_inflater");
    }
