...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean m3835c(int i, int i2) {
        int i3;
        int i4;
        int i5;
        ...
        if (view3 == null) {
            ...
            view3.measure(i, 0);
            iM3834c = m3834c(view3);
            int measuredHeight = view3.getMeasuredHeight() - iM3834c;
            paddingBottom += iM3834c;
        ...
        if (view3 != null) {
            int i10 = paddingBottom - iM3834c;
            int iMin = Math.min(i9, i3);
            if (iMin > 0) {
                i9 -= iMin;
                iM3834c += iMin;
            }
            view3.measure(i, View.MeasureSpec.makeMeasureSpec(iM3834c, 1073741824));
        ...
        if (mode2 != 1073741824) {
            m3836d(childCount, i2);
        }
        return true;
    }

    /* JADX INFO: renamed from: d */
    private void m3836d(int i, int i2) {
    ...
    /* JADX INFO: renamed from: c */
    private static int m3834c(View view) {
        int iM2607k = ViewCompat.m2607k(view);
        if (iM2607k <= 0) {
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                if (viewGroup.getChildCount() == 1) {
                    return m3834c(viewGroup.getChildAt(0));
                }
            }
            return 0;
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                int i11 = layoutParams.topMargin + (m4256c(i9) ? i8 + intrinsicHeight : i8);
                m3833a(childAt, i5, i11, measuredWidth, measuredHeight2);
    ...
    private void m3833a(View view, int i, int i2, int i3, int i4) {
