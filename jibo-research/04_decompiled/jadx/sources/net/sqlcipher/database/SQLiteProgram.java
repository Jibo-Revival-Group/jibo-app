...
public abstract class SQLiteProgram extends SQLiteClosable {
    ...
    SQLiteProgram(SQLiteDatabase sQLiteDatabase, String str) {
        ...
        if (this.mSql.length() >= 6) {
            strSubstring = this.mSql.substring(0, 6);
        } else {
            strSubstring = this.mSql;
        }
        if (!strSubstring.equalsIgnoreCase("INSERT") && !strSubstring.equalsIgnoreCase("UPDATE") && !strSubstring.equalsIgnoreCase("REPLAC") && !strSubstring.equalsIgnoreCase(HttpMethods.DELETE) && !strSubstring.equalsIgnoreCase("SELECT")) {
