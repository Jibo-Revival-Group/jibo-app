...
.method public a_(Landroid/arch/core/internal/SafeIterableMap$Entry;)V
    ...
    iget-object v0, v0, Landroid/arch/core/internal/SafeIterableMap$Entry;->d:Landroid/arch/core/internal/SafeIterableMap$Entry;
...
.method public hasNext()Z
    ...
    .line 315
    iget-boolean v2, p0, Landroid/arch/core/internal/SafeIterableMap$IteratorWithAdditions;->c:Z

    if-eqz v2, :cond_2

    .line 316
    iget-object v2, p0, Landroid/arch/core/internal/SafeIterableMap$IteratorWithAdditions;->a:Landroid/arch/core/internal/SafeIterableMap;

    invoke-static {v2}, Landroid/arch/core/internal/SafeIterableMap;->a(Landroid/arch/core/internal/SafeIterableMap;)Landroid/arch/core/internal/SafeIterableMap$Entry;
    ...
    .line 318
    :cond_2
    iget-object v2, p0, Landroid/arch/core/internal/SafeIterableMap$IteratorWithAdditions;->b:Landroid/arch/core/internal/SafeIterableMap$Entry;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/arch/core/internal/SafeIterableMap$IteratorWithAdditions;->b:Landroid/arch/core/internal/SafeIterableMap$Entry;

    iget-object v2, v2, Landroid/arch/core/internal/SafeIterableMap$Entry;->c:Landroid/arch/core/internal/SafeIterableMap$Entry;
