...
.method constructor <init>(Landroid/support/v7/widget/RecyclerView;Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/StateListDrawable;Landroid/graphics/drawable/Drawable;III)V
    ...
    .line 103
    iput v1, p0, Landroid/support/v7/widget/FastScroller;->s:I

    .line 104
    iput v1, p0, Landroid/support/v7/widget/FastScroller;->t:I

    .line 111
    iput-boolean v1, p0, Landroid/support/v7/widget/FastScroller;->v:Z

    .line 112
    iput-boolean v1, p0, Landroid/support/v7/widget/FastScroller;->w:Z

    .line 113
    iput v1, p0, Landroid/support/v7/widget/FastScroller;->x:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/FastScroller;->z:[I

    .line 117
    new-array v0, v2, [I

    iput-object v0, p0, Landroid/support/v7/widget/FastScroller;->A:[I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/FastScroller;->B:Landroid/animation/ValueAnimator;

    .line 119
    iput v1, p0, Landroid/support/v7/widget/FastScroller;->C:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/FastScroller;->E:Landroid/support/v7/widget/RecyclerView$OnScrollListener;
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->m:I
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->n:I
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->q:I
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->r:I
...
.method private a(F)V
    ...
    .line 460
    :cond_1
    iput v2, p0, Landroid/support/v7/widget/FastScroller;->c:F
...
.method private b()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/FastScroller;->E:Landroid/support/v7/widget/RecyclerView$OnScrollListener;
...
.method private b(F)V
    ...
    .line 477
    :cond_1
    iput v2, p0, Landroid/support/v7/widget/FastScroller;->f:F
...
.method private b(I)V
    ...
    sget-object v1, Landroid/support/v7/widget/FastScroller;->g:[I
...
.method private e()Z
    ...
    invoke-static {v1}, Landroid/support/v4/view/ViewCompat;->e(Landroid/view/View;)I
...
.method private g()[I
    ...
    iget v3, p0, Landroid/support/v7/widget/FastScroller;->j:I
...
.method private h()[I
    ...
    iget v2, p0, Landroid/support/v7/widget/FastScroller;->s:I
...
.method public a()V
    ...
    .line 233
    :pswitch_2
    iput v4, p0, Landroid/support/v7/widget/FastScroller;->C:I
...
.method a(II)V
    ...
    .line 353
    iget-boolean v0, p0, Landroid/support/v7/widget/FastScroller;->v:Z

    if-nez v0, :cond_3

    iget-boolean v0, p0, Landroid/support/v7/widget/FastScroller;->w:Z
    ...
    .line 355
    invoke-direct {p0, v2}, Landroid/support/v7/widget/FastScroller;->b(I)V
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->b:I
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->a:I
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->e:I
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->d:I
...
.method a(FF)Z
    ...
    iget v1, p0, Landroid/support/v7/widget/FastScroller;->a:I
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    .line 384
    iget v2, p0, Landroid/support/v7/widget/FastScroller;->x:I
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v7/widget/FastScroller;->a(FF)Z
    ...
    iput v1, p0, Landroid/support/v7/widget/FastScroller;->f:F

    .line 397
    :cond_1
    :goto_0
    invoke-direct {p0, v5}, Landroid/support/v7/widget/FastScroller;->b(I)V
    ...
    .line 393
    iput v5, p0, Landroid/support/v7/widget/FastScroller;->y:I
    ...
    iput v1, p0, Landroid/support/v7/widget/FastScroller;->c:F
...
.method public b(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/FastScroller;->a(FF)Z
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/FastScroller;->b(FF)Z
    ...
    .line 421
    iput v4, p0, Landroid/support/v7/widget/FastScroller;->y:I
    ...
    iput v0, p0, Landroid/support/v7/widget/FastScroller;->c:F
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/FastScroller;->b(F)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/FastScroller;->a(F)V
...
.method b(FF)Z
    ...
    iget v1, p0, Landroid/support/v7/widget/FastScroller;->d:I
