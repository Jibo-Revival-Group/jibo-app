...
.method public run()V
    ...
    iget-object v14, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->e:Landroid/widget/OverScroller;
    ...
    iget-object v15, v2, Landroid/support/v7/widget/RecyclerView$LayoutManager;->t:Landroid/support/v7/widget/RecyclerView$SmoothScroller;
    ...
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->c:I
    ...
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->d:I
    ...
    iput v0, v1, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->c:I
    ...
    iput v0, v1, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->d:I
    ...
    invoke-static {v2}, Landroid/support/v4/os/TraceCompat;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v10, v3, v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->a(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
    ...
    invoke-virtual {v2, v9, v3, v6}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->b(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
    ...
    invoke-virtual {v15}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->g()Z
    ...
    .line 4970
    invoke-virtual {v15}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->h()Z
    ...
    invoke-virtual {v6}, Landroid/support/v7/widget/RecyclerView$State;->e()I
    ...
    .line 4973
    invoke-virtual {v15}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->f()V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;->a()V
    ...
    invoke-static {v15, v2, v3}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->a(Landroid/support/v7/widget/RecyclerView$SmoothScroller;II)V
    ...
    .line 4974
    :cond_13
    invoke-virtual {v15}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->i()I
    ...
    invoke-virtual {v15, v6}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->d(I)V
    ...
    invoke-static {v15, v6, v7}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->a(Landroid/support/v7/widget/RecyclerView$SmoothScroller;II)V
    ...
    invoke-virtual {v2, v3, v10, v9}, Landroid/support/v7/widget/GapWorker;->a(Landroid/support/v7/widget/RecyclerView;II)V
