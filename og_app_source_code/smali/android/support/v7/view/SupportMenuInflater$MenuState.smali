...
.method public constructor <init>(Landroid/support/v7/view/SupportMenuInflater;Landroid/view/Menu;)V
    ...
    .line 335
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->E:Landroid/content/res/ColorStateList;

    .line 336
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->F:Landroid/graphics/PorterDuff$Mode;
...
.method private a(Landroid/view/MenuItem;)V
    ...
    .line 464
    iget-boolean v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->u:Z

    invoke-interface {p1, v0}, Landroid/view/MenuItem;->setChecked(Z)Landroid/view/MenuItem;

    move-result-object v0

    iget-boolean v3, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->v:Z
    ...
    iget-boolean v3, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->w:Z
    ...
    iget v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->t:I
    ...
    .line 471
    iget v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->x:I
    ...
    .line 475
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->B:Ljava/lang/String;
    ...
    iget-object v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->B:Ljava/lang/String;
    ...
    .line 500
    :goto_2
    iget v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->y:I
    ...
    .line 513
    :cond_7
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroid/support/v4/view/MenuItemCompat;->a(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    .line 514
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->D:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroid/support/v4/view/MenuItemCompat;->b(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    .line 515
    iget-char v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->p:C

    iget v1, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->q:I

    invoke-static {p1, v0, v1}, Landroid/support/v4/view/MenuItemCompat;->b(Landroid/view/MenuItem;CI)V

    .line 517
    iget-char v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->r:C

    iget v1, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->s:I

    invoke-static {p1, v0, v1}, Landroid/support/v4/view/MenuItemCompat;->a(Landroid/view/MenuItem;CI)V

    .line 519
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->F:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 522
    :cond_8
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->E:Landroid/content/res/ColorStateList;
...
.method public b(Landroid/util/AttributeSet;)V
    ...
    iput-char v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->r:C
    ...
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->s:I
    ...
    :goto_0
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->t:I
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->v:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->w:Z
    ...
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->x:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->B:Ljava/lang/String;
    ...
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->y:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->A:Ljava/lang/String;

    .line 420
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->A:Ljava/lang/String;
    ...
    sget-object v1, Landroid/support/v7/view/SupportMenuInflater;->b:[Ljava/lang/Class;

    iget-object v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->b:Landroid/support/v7/view/SupportMenuInflater;

    iget-object v4, v4, Landroid/support/v7/view/SupportMenuInflater;->d:[Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->C:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->D:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->F:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 430
    :cond_4
    iput-object v6, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->a:Landroid/support/v4/view/ActionProvider;

    goto :goto_3

    .line 441
    :cond_5
    iput-object v6, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->F:Landroid/graphics/PorterDuff$Mode;

    goto :goto_4

    .line 447
    :cond_6
    iput-object v6, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->E:Landroid/content/res/ColorStateList;
