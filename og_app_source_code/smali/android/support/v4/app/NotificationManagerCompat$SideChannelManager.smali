...
.method private a()V
    ...
    .line 410
    iget-object v0, p0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->e:Ljava/util/Set;
    ...
    .line 414
    :cond_1
    iput-object v1, p0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->e:Ljava/util/Set;
    ...
    .line 433
    iget-object v3, p0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->d:Ljava/util/Map;
    ...
    .line 441
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->d:Ljava/util/Map;
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->b(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V
...
.method private a(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object v1, v0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;->c:Landroid/support/v4/app/INotificationSideChannel;

    .line 367
    const/4 v1, 0x0

    iput v1, v0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;->e:I

    .line 368
    invoke-direct {p0, v0}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->d(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V
...
.method private b(Landroid/support/v4/app/NotificationManagerCompat$Task;)V
    .locals 3
    ...
    .line 358
    iget-object v2, v0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;->d:Ljava/util/ArrayDeque;
...
.method private c(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V
    ...
    iget-object v2, p1, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;->d:Ljava/util/ArrayDeque;
    ...
    .line 499
    iget-object v0, p1, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;->d:Ljava/util/ArrayDeque;
    ...
    iget v1, p1, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;->e:I
    ...
    .line 506
    :cond_2
    iget-object v1, p0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->c:Landroid/os/Handler;
...
.method private d(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V
    ...
    .line 537
    :cond_5
    iget-object v1, p1, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;->c:Landroid/support/v4/app/INotificationSideChannel;

    invoke-interface {v0, v1}, Landroid/support/v4/app/NotificationManagerCompat$Task;->a(Landroid/support/v4/app/INotificationSideChannel;)V
...
# virtual methods
.method public a(Landroid/support/v4/app/NotificationManagerCompat$Task;)V
    .locals 2
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->b(Landroid/support/v4/app/NotificationManagerCompat$Task;)V
    ...
    .line 343
    iget-object v2, v0, Landroid/support/v4/app/NotificationManagerCompat$ServiceConnectedEvent;->a:Landroid/content/ComponentName;

    iget-object v0, v0, Landroid/support/v4/app/NotificationManagerCompat$ServiceConnectedEvent;->b:Landroid/os/IBinder;

    invoke-direct {p0, v2, v0}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->a(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->a(Landroid/content/ComponentName;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->b(Landroid/content/ComponentName;)V
