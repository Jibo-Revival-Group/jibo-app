...
.method private a(Ljava/lang/String;)Landroid/support/v4/app/FragmentTabHost$TabInfo;
    .locals 4
    ...
    .line 366
    iget-object v3, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->a:Ljava/lang/String;
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/FragmentTransaction;)Landroid/support/v4/app/FragmentTransaction;
    ...
    .prologue
    .line 334
    invoke-direct {p0, p1}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;)Landroid/support/v4/app/FragmentTabHost$TabInfo;

    move-result-object v0

    .line 335
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->f:Landroid/support/v4/app/FragmentTabHost$TabInfo;
    ...
    iget-object v1, v1, Landroid/support/v4/app/FragmentTabHost$TabInfo;->d:Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v1}, Landroid/support/v4/app/FragmentTransaction;->b(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/FragmentTransaction;
    ...
    .line 347
    iget-object v1, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->d:Landroid/support/v4/app/Fragment;
    ...
    iget-object v2, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->b:Ljava/lang/Class;
    ...
    iget-object v3, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->c:Landroid/os/Bundle;
    ...
    iput-object v1, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->d:Landroid/support/v4/app/Fragment;

    .line 350
    iget v1, p0, Landroid/support/v4/app/FragmentTabHost;->d:I

    iget-object v2, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->d:Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v1}, Landroid/support/v4/app/FragmentTransaction;->c(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/FragmentTransaction;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v6, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->a:Ljava/lang/String;

    invoke-virtual {v5, v6}, Landroid/support/v4/app/FragmentManager;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;

    move-result-object v5

    iput-object v5, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->d:Landroid/support/v4/app/Fragment;

    .line 266
    iget-object v5, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->d:Landroid/support/v4/app/Fragment;
    ...
    .line 267
    iget-object v5, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->a:Ljava/lang/String;
    ...
    .line 278
    :cond_2
    iget-object v0, v0, Landroid/support/v4/app/FragmentTabHost$TabInfo;->d:Landroid/support/v4/app/Fragment;
