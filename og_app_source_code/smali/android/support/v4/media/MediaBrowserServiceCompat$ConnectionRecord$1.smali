...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;)V
    ...
    .prologue
    .line 570
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord$1;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;
...
.method public run()V
    ...
    .prologue
    .line 573
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord$1;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;

    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;->f:Landroid/support/v4/media/MediaBrowserServiceCompat;

    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserServiceCompat;->b:Landroid/support/v4/util/ArrayMap;

    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord$1;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;
