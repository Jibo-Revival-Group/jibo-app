...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 92
    sget-object v0, Landroid/support/transition/Styleable;->i:[I
...
.method private q()V
    ...
    .line 365
    invoke-virtual {v0, v1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/Transition;
...
.method public synthetic a(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/Transition;
    .locals 1

    .prologue
    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/TransitionSet;->c(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/TransitionSet;
...
.method public a(Landroid/support/transition/Transition$EpicenterCallback;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/Transition$EpicenterCallback;)V
...
.method public a(Landroid/support/transition/TransitionPropagation;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/TransitionPropagation;)V
...
.method public a(Landroid/support/transition/TransitionValues;)V
    ...
    .line 472
    invoke-virtual {v0, p1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/TransitionValues;)V
...
.method public synthetic b(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/Transition;
    .locals 1

    .prologue
    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/TransitionSet;->d(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/TransitionSet;
...
.method public b(Landroid/support/transition/TransitionValues;)V
    ...
    .line 484
    invoke-virtual {v0, p1}, Landroid/support/transition/Transition;->b(Landroid/support/transition/TransitionValues;)V
...
.method public c(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/TransitionSet;
    .locals 1
...
.method c(Landroid/support/transition/TransitionValues;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/transition/Transition;->c(Landroid/support/transition/TransitionValues;)V
...
.method public d(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/TransitionSet;
    .locals 1
...
.method protected e()V
    ...
    invoke-virtual {v0, v3}, Landroid/support/transition/Transition;->a(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/Transition;
