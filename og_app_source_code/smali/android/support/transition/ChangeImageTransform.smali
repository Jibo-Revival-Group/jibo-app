...
.method private a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    ...
    .line 176
    sget-object v0, Landroid/support/transition/ChangeImageTransform;->i:Landroid/util/Property;

    sget-object v1, Landroid/support/transition/ChangeImageTransform;->h:Landroid/animation/TypeEvaluator;
...
.method private static b(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    .prologue
    .line 187
    sget-object v0, Landroid/support/transition/ChangeImageTransform$3;->a:[I
    ...
    .line 189
    :pswitch_0
    invoke-static {p0}, Landroid/support/transition/ChangeImageTransform;->c(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private static c(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    .locals 4
...
.method private d(Landroid/support/transition/TransitionValues;)V
    ...
    invoke-static {v0}, Landroid/support/transition/ChangeImageTransform;->b(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 139
    :cond_3
    iget-object v2, p2, Landroid/support/transition/TransitionValues;->a:Ljava/util/Map;
    ...
    .line 140
    iget-object v3, p3, Landroid/support/transition/TransitionValues;->a:Ljava/util/Map;
    ...
    .line 154
    invoke-static {v0}, Landroid/support/transition/ImageViewUtils;->a(Landroid/widget/ImageView;)V
    ...
    .line 158
    :cond_8
    invoke-direct {p0, v0}, Landroid/support/transition/ChangeImageTransform;->a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;

    move-result-object v1

    .line 170
    :goto_2
    invoke-static {v0, v1}, Landroid/support/transition/ImageViewUtils;->a(Landroid/widget/ImageView;Landroid/animation/Animator;)V
    ...
    .line 166
    :cond_b
    sget-object v1, Landroid/support/transition/ChangeImageTransform;->i:Landroid/util/Property;

    invoke-virtual {v1, v0, v2}, Landroid/util/Property;->set(Ljava/lang/Object;Ljava/lang/Object;)V

    .line 167
    invoke-direct {p0, v0, v2, v3}, Landroid/support/transition/ChangeImageTransform;->a(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
...
.method public a(Landroid/support/transition/TransitionValues;)V
    ...
    .prologue
    .line 104
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeImageTransform;->d(Landroid/support/transition/TransitionValues;)V
