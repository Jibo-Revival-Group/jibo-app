...
.method public constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/PointerIconCompat;->a(Landroid/content/Context;I)Landroid/support/v4/view/PointerIconCompat;

    move-result-object v0

    .line 1525
    invoke-static {p0, v0}, Landroid/support/v4/view/ViewCompat;->a(Landroid/view/View;Landroid/support/v4/view/PointerIconCompat;)V
...
.method private a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    .line 1728
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;
    ...
    .line 1729
    :goto_0
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;

    if-eqz v2, :cond_4

    iget-object v2, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;

    invoke-virtual {v2}, Landroid/support/design/widget/TabLayout$Tab;->d()Ljava/lang/CharSequence;

    move-result-object v2

    .line 1730
    :goto_1
    iget-object v4, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;

    if-eqz v4, :cond_5

    iget-object v4, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;

    invoke-virtual {v4}, Landroid/support/design/widget/TabLayout$Tab;->g()Ljava/lang/CharSequence;
...
.method a()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout$TabView;->a(Landroid/support/design/widget/TabLayout$Tab;)V
...
.method a(Landroid/support/design/widget/TabLayout$Tab;)V
    ...
    .line 1650
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;
...
.method final b()V
    ...
    invoke-virtual {v4}, Landroid/support/design/widget/TabLayout$Tab;->a()Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/design/widget/TabLayout$Tab;->f()Z
...
.method public performClick()Z
    ...
    .line 1533
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/TabLayout$Tab;->e()V
