...
.field private final j:Lcom/google/firebase/FirebaseOptions;
...
.field private p:Lcom/google/firebase/FirebaseApp$zzb;
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/FirebaseOptions;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->k:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->l:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->m:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->n:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->o:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->h:Landroid/content/Context;

    invoke-static {p2}, Lcom/google/android/gms/common/internal/zzbq;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->i:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->j:Lcom/google/firebase/FirebaseOptions;

    new-instance v0, Lcom/google/firebase/internal/zza;

    invoke-direct {v0}, Lcom/google/firebase/internal/zza;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->p:Lcom/google/firebase/FirebaseApp$zzb;
...
.method public static a(Landroid/content/Context;)Lcom/google/firebase/FirebaseApp;
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->g:Ljava/lang/Object;
    ...
    :cond_1
    :try_start_1
    invoke-static {p0, v0}, Lcom/google/firebase/FirebaseApp;->a(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;)Lcom/google/firebase/FirebaseApp;
...
.method public static a(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    ...
    invoke-static {p0}, Lcom/google/firebase/internal/zzb;->a(Landroid/content/Context;)Lcom/google/firebase/internal/zzb;
    ...
    :goto_0
    sget-object v2, Lcom/google/firebase/FirebaseApp;->g:Ljava/lang/Object;
    ...
    invoke-static {v0}, Lcom/google/firebase/internal/zzb;->a(Lcom/google/firebase/FirebaseApp;)V

    const-class v1, Lcom/google/firebase/FirebaseApp;

    sget-object v2, Lcom/google/firebase/FirebaseApp;->b:Ljava/util/List;

    invoke-direct {v0, v1, v0, v2}, Lcom/google/firebase/FirebaseApp;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/google/firebase/FirebaseApp;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V
...
.method private final a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->h:Landroid/content/Context;

    invoke-static {v0}, Landroid/support/v4/content/ContextCompat;->b(Landroid/content/Context;)Z
    ...
    invoke-static {v0}, Lcom/google/firebase/FirebaseApp$zzc;->a(Landroid/content/Context;)V
...
.method public static a(Z)V
    ...
    sget-object v3, Lcom/google/firebase/FirebaseApp;->g:Ljava/lang/Object;
    ...
    iget-object v5, v1, Lcom/google/firebase/FirebaseApp;->k:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p0}, Lcom/google/firebase/FirebaseApp;->b(Z)V
...
.method private final b(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/google/firebase/FirebaseApp$zza;->a(Z)V
...
.method public static d()Lcom/google/firebase/FirebaseApp;
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzs;->a()Ljava/lang/String;
...
.method private final g()V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->l:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private final h()V
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->b:Ljava/util/List;

    invoke-direct {p0, v0, p0, v1}, Lcom/google/firebase/FirebaseApp;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->c:Ljava/util/List;

    invoke-direct {p0, v0, p0, v1}, Lcom/google/firebase/FirebaseApp;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V

    const-class v0, Landroid/content/Context;

    iget-object v1, p0, Lcom/google/firebase/FirebaseApp;->h:Landroid/content/Context;

    sget-object v2, Lcom/google/firebase/FirebaseApp;->d:Ljava/util/List;

    invoke-direct {p0, v0, v1, v2}, Lcom/google/firebase/FirebaseApp;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V
...
.method public c()Lcom/google/firebase/FirebaseOptions;
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->j:Lcom/google/firebase/FirebaseOptions;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/firebase/FirebaseApp;->j:Lcom/google/firebase/FirebaseOptions;
