...
.method public a(Lio/fabric/sdk/android/services/common/Crash$FatalException;)V
    .locals 3
    ...
    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/Crash$FatalException;->a()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/Crash$FatalException;->b()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/crashlytics/android/answers/SessionAnalyticsManager;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Lio/fabric/sdk/android/services/common/Crash$LoggedException;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/Crash$LoggedException;->a()Ljava/lang/String;
...
.method protected a_()Z
    ...
    .line 341
    :try_start_0
    invoke-virtual {p0}, Lcom/crashlytics/android/answers/Answers;->r()Landroid/content/Context;
    ...
    .line 358
    :goto_1
    invoke-virtual {p0}, Lcom/crashlytics/android/answers/Answers;->q()Lio/fabric/sdk/android/services/common/IdManager;
    ...
    iput-object v1, p0, Lcom/crashlytics/android/answers/Answers;->a:Lcom/crashlytics/android/answers/SessionAnalyticsManager;

    .line 360
    iget-object v1, p0, Lcom/crashlytics/android/answers/Answers;->a:Lcom/crashlytics/android/answers/SessionAnalyticsManager;

    invoke-virtual {v1}, Lcom/crashlytics/android/answers/SessionAnalyticsManager;->b()V
...
.method protected d()Ljava/lang/Boolean;
    ...
    iget-boolean v1, v1, Lio/fabric/sdk/android/services/settings/FeaturesSettingsData;->d:Z
    ...
    iget-object v0, v0, Lio/fabric/sdk/android/services/settings/SettingsData;->e:Lio/fabric/sdk/android/services/settings/AnalyticsSettingsData;

    .line 381
    invoke-virtual {p0}, Lcom/crashlytics/android/answers/Answers;->e()Ljava/lang/String;

    move-result-object v2

    .line 380
    invoke-virtual {v1, v0, v2}, Lcom/crashlytics/android/answers/SessionAnalyticsManager;->a(Lio/fabric/sdk/android/services/settings/AnalyticsSettingsData;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/crashlytics/android/answers/SessionAnalyticsManager;->c()V
...
.method protected synthetic f()Ljava/lang/Object;
    ...
    .prologue
    .line 20
    invoke-virtual {p0}, Lcom/crashlytics/android/answers/Answers;->d()Ljava/lang/Boolean;
