...
.method public static a()Lio/fabric/sdk/android/services/settings/Settings;
    .locals 1

    .prologue
    .line 55
    invoke-static {}, Lio/fabric/sdk/android/services/settings/Settings$LazyHolder;->a()Lio/fabric/sdk/android/services/settings/Settings;
...
# virtual methods
.method public declared-synchronized a(Lio/fabric/sdk/android/Kit;Lio/fabric/sdk/android/services/common/IdManager;Lio/fabric/sdk/android/services/network/HttpRequestFactory;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/settings/Settings;
    .locals 21
    ...
    iget-boolean v4, v0, Lio/fabric/sdk/android/services/settings/Settings;->d:Z
    :try_end_0
    ...
    iget-object v4, v0, Lio/fabric/sdk/android/services/settings/Settings;->c:Lio/fabric/sdk/android/services/settings/SettingsController;

    if-nez v4, :cond_1

    .line 76
    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/Kit;->r()Landroid/content/Context;
    ...
    invoke-virtual {v5, v4}, Lio/fabric/sdk/android/services/common/ApiKey;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    iput-object v5, v0, Lio/fabric/sdk/android/services/settings/Settings;->c:Lio/fabric/sdk/android/services/settings/SettingsController;
    ...
    iput-boolean v4, v0, Lio/fabric/sdk/android/services/settings/Settings;->d:Z
    :try_end_1
...
.method public b()Lio/fabric/sdk/android/services/settings/SettingsData;
    .locals 3
