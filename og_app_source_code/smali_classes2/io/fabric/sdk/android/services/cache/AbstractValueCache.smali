...
.method private b(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    .line 70
    :cond_0
    invoke-virtual {p0, p1, p2}, Lio/fabric/sdk/android/services/cache/AbstractValueCache;->a(Landroid/content/Context;Ljava/lang/Object;)V
...
.method public final declared-synchronized a(Landroid/content/Context;Lio/fabric/sdk/android/services/cache/ValueLoader;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lio/fabric/sdk/android/services/cache/AbstractValueCache;->a(Landroid/content/Context;)Ljava/lang/Object;
    ...
    .line 40
    :goto_0
    invoke-direct {p0, p1, v0}, Lio/fabric/sdk/android/services/cache/AbstractValueCache;->b(Landroid/content/Context;Ljava/lang/Object;)V
    :try_end_0
    ...
    :cond_1
    :try_start_1
    invoke-interface {p2, p1}, Lio/fabric/sdk/android/services/cache/ValueLoader;->b(Landroid/content/Context;)Ljava/lang/Object;
    :try_end_1
