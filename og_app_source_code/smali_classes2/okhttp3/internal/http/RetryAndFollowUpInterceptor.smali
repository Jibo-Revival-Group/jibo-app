...
.method private a(Lokhttp3/HttpUrl;)Lokhttp3/Address;
    ...
    invoke-virtual {v0}, Lokhttp3/OkHttpClient;->j()Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {v0}, Lokhttp3/OkHttpClient;->k()Ljavax/net/ssl/HostnameVerifier;
    ...
    invoke-virtual {v0}, Lokhttp3/OkHttpClient;->l()Lokhttp3/CertificatePinner;
    ...
    invoke-virtual {v3}, Lokhttp3/OkHttpClient;->h()Lokhttp3/Dns;

    move-result-object v3

    iget-object v4, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a:Lokhttp3/OkHttpClient;

    invoke-virtual {v4}, Lokhttp3/OkHttpClient;->i()Ljavax/net/SocketFactory;

    move-result-object v4

    iget-object v8, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a:Lokhttp3/OkHttpClient;

    .line 198
    invoke-virtual {v8}, Lokhttp3/OkHttpClient;->n()Lokhttp3/Authenticator;

    move-result-object v8

    iget-object v9, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a:Lokhttp3/OkHttpClient;
    ...
    iget-object v10, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a:Lokhttp3/OkHttpClient;

    invoke-virtual {v10}, Lokhttp3/OkHttpClient;->t()Ljava/util/List;

    move-result-object v10

    iget-object v11, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a:Lokhttp3/OkHttpClient;

    invoke-virtual {v11}, Lokhttp3/OkHttpClient;->u()Ljava/util/List;

    move-result-object v11

    iget-object v12, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a:Lokhttp3/OkHttpClient;
...
.method private a(Lokhttp3/Response;)Lokhttp3/Request;
    ...
    .line 316
    invoke-static {v3}, Lokhttp3/internal/http/HttpMethod;->e(Ljava/lang/String;)Z
...
.method public a(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 107
    invoke-virtual {v4}, Lokhttp3/OkHttpClient;->o()Lokhttp3/ConnectionPool;
    ...
    iget-object v7, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->d:Ljava/lang/Object;
    ...
    iput-object v2, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->c:Lokhttp3/internal/connection/StreamAllocation;
    ...
    iget-object v7, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->c:Lokhttp3/internal/connection/StreamAllocation;

    const/4 v8, 0x0

    const/4 v9, 0x0

    invoke-virtual {v1, v6, v7, v8, v9}, Lokhttp3/internal/http/RealInterceptorChain;->a(Lokhttp3/Request;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/http/HttpCodec;Lokhttp3/internal/connection/RealConnection;)Lokhttp3/Response;
    :try_end_0
    ...
    .line 155
    iget-boolean v2, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->b:Z
    ...
    invoke-direct {p0, v7, v8, v6}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a(Ljava/io/IOException;ZLokhttp3/Request;)Z
    ...
    .line 132
    :goto_1
    invoke-direct {p0, v1, v7, v6}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a(Ljava/io/IOException;ZLokhttp3/Request;)Z
    ...
    .line 168
    :cond_6
    invoke-virtual {v6}, Lokhttp3/Request;->d()Lokhttp3/RequestBody;
    ...
    .line 173
    :cond_7
    invoke-virtual {v6}, Lokhttp3/Request;->a()Lokhttp3/HttpUrl;
    ...
    iget-object v7, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a:Lokhttp3/OkHttpClient;

    .line 176
    invoke-virtual {v7}, Lokhttp3/OkHttpClient;->o()Lokhttp3/ConnectionPool;
    ...
    invoke-direct {p0, v8}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->a(Lokhttp3/HttpUrl;)Lokhttp3/Address;

    move-result-object v8

    iget-object v9, p0, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v4}, Lokhttp3/internal/connection/StreamAllocation;->a()Lokhttp3/internal/http/HttpCodec;
