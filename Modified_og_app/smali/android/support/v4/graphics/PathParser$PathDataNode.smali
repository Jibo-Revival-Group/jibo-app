...
.method constructor <init>(C[F)V
    ...
    .line 320
    iput-char p1, p0, Landroid/support/v4/graphics/PathParser$PathDataNode;->a:C

    .line 321
    iput-object p2, p0, Landroid/support/v4/graphics/PathParser$PathDataNode;->b:[F
...
.method constructor <init>(Landroid/support/v4/graphics/PathParser$PathDataNode;)V
    ...
    .line 325
    iget-char v0, p1, Landroid/support/v4/graphics/PathParser$PathDataNode;->a:C

    iput-char v0, p0, Landroid/support/v4/graphics/PathParser$PathDataNode;->a:C

    .line 326
    iget-object v0, p1, Landroid/support/v4/graphics/PathParser$PathDataNode;->b:[F

    const/4 v1, 0x0

    iget-object v2, p1, Landroid/support/v4/graphics/PathParser$PathDataNode;->b:[F

    array-length v2, v2

    invoke-static {v0, v1, v2}, Landroid/support/v4/graphics/PathParser;->a([FII)[F

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/graphics/PathParser$PathDataNode;->b:[F
...
.method private static a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v2 .. v11}, Landroid/support/v4/graphics/PathParser$PathDataNode;->a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v3 .. v21}, Landroid/support/v4/graphics/PathParser$PathDataNode;->a(Landroid/graphics/Path;DDDDDDDDD)V
...
.method private static a(Landroid/graphics/Path;[FCC[F)V
    ...
    invoke-static/range {v3 .. v12}, Landroid/support/v4/graphics/PathParser$PathDataNode;->a(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method public static a([Landroid/support/v4/graphics/PathParser$PathDataNode;Landroid/graphics/Path;)V
    .locals 5
    ...
    invoke-static {p1, v2, v1, v3, v4}, Landroid/support/v4/graphics/PathParser$PathDataNode;->a(Landroid/graphics/Path;[FCC[F)V

    .line 340
    aget-object v1, p0, v0

    iget-char v1, v1, Landroid/support/v4/graphics/PathParser$PathDataNode;->a:C
...
# virtual methods
.method public a(Landroid/support/v4/graphics/PathParser$PathDataNode;Landroid/support/v4/graphics/PathParser$PathDataNode;F)V
    .locals 4
    ...
    :goto_0
    iget-object v1, p1, Landroid/support/v4/graphics/PathParser$PathDataNode;->b:[F
    ...
    .line 356
    iget-object v1, p0, Landroid/support/v4/graphics/PathParser$PathDataNode;->b:[F
    ...
    iget-object v3, p2, Landroid/support/v4/graphics/PathParser$PathDataNode;->b:[F
