...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->i:Ljava/util/concurrent/atomic/AtomicInteger;

    .line 454
    const/4 v0, 0x0

    sput-boolean v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->c:Z
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->a:Ljava/util/WeakHashMap;
...
.method public A(Landroid/view/View;)F
    ...
    .prologue
    .line 898
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->v(Landroid/view/View;)F

    move-result v0

    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->u(Landroid/view/View;)F
...
.method public B(Landroid/view/View;)Z
    ...
    .line 466
    sget-boolean v2, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->c:Z
    ...
    .line 469
    :cond_0
    sget-object v2, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->b:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->b:Ljava/lang/reflect/Field;
...
.method public C(Landroid/view/View;)Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    .prologue
    .line 695
    iget-object v0, p0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->a:Ljava/util/WeakHashMap;
    ...
    .line 701
    iget-object v1, p0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->a:Ljava/util/WeakHashMap;
...
.method public a(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    .prologue
    .line 523
    invoke-virtual {p0}, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->a()J
...
.method public a(Landroid/view/View;Ljava/lang/String;)V
    ...
    .prologue
    .line 707
    sget-object v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->h:Ljava/util/WeakHashMap;
    ...
    sput-object v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->h:Ljava/util/WeakHashMap;
...
.method public c(Landroid/view/View;I)V
    ...
    .line 928
    invoke-static {p1}, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->D(Landroid/view/View;)V
    ...
    invoke-static {v0}, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->D(Landroid/view/View;)V
...
.method public f(Landroid/view/View;)I
    ...
    .line 649
    sget-boolean v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->e:Z
    ...
    sput-object v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->d:Ljava/lang/reflect/Field;

    .line 652
    sget-object v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->d:Ljava/lang/reflect/Field;
    ...
    .line 656
    :goto_0
    sput-boolean v2, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->e:Z
...
.method public g(Landroid/view/View;)I
    ...
    .line 672
    sget-boolean v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->g:Z
    ...
    sput-object v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->f:Ljava/lang/reflect/Field;

    .line 675
    sget-object v0, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->f:Ljava/lang/reflect/Field;
    ...
    .line 679
    :goto_0
    sput-boolean v2, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->g:Z
...
.method public p(Landroid/view/View;)Landroid/view/Display;
    ...
    .prologue
    .line 960
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewCompat$ViewCompatBaseImpl;->s(Landroid/view/View;)Z
