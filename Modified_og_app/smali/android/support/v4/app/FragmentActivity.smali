...
.method private allocateRequestIndex(Landroid/support/v4/app/Fragment;)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/util/SparseArrayCompat;->f(I)I
...
.method private static markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/Lifecycle$State;)Z
    ...
    .line 1001
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentManager;->f()Ljava/util/List;
    ...
    invoke-virtual {v1, p1}, Landroid/arch/lifecycle/LifecycleRegistry;->a(Landroid/arch/lifecycle/Lifecycle$State;)V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, p2, p3, p4}, Landroid/support/v4/app/LoaderManager;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentController;->b()V
    ...
    .line 162
    :cond_3
    invoke-static {}, Landroid/support/v4/app/ActivityCompat;->a()Landroid/support/v4/app/ActivityCompat$PermissionCompatDelegate;
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Landroid/support/v4/app/ActivityCompat$PermissionCompatDelegate;->a(Landroid/app/Activity;IILandroid/content/Intent;)Z
...
.method public onBackPressed()V
    ...
    .line 178
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentManager;->g()Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 326
    iget-object v3, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->b:Landroid/arch/lifecycle/ViewModelStore;
    ...
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->c:Landroid/support/v4/app/FragmentManagerNonConfig;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentController;->e()V
...
.method protected onPostResume()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentController;->n()Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentController;->d()Landroid/support/v4/app/FragmentManagerNonConfig;
    ...
    iput-object v1, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->b:Landroid/arch/lifecycle/ViewModelStore;

    .line 555
    iput-object v2, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->c:Landroid/support/v4/app/FragmentManagerNonConfig;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentController;->c()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/util/SparseArrayCompat;->d(I)I
