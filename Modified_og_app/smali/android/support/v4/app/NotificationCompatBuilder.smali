...
.method constructor <init>(Landroid/support/v4/app/NotificationCompat$Builder;)V
    ...
    .line 62
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompatBuilder;->b:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iget-object v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->a:Landroid/content/Context;

    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->H:Ljava/lang/String;
    ...
    .line 68
    :goto_0
    iget-object v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->M:Landroid/app/Notification;
    ...
    iget-object v5, p1, Landroid/support/v4/app/NotificationCompat$Builder;->g:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->d:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->i:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->e:Landroid/app/PendingIntent;
    ...
    iget-object v5, p1, Landroid/support/v4/app/NotificationCompat$Builder;->f:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->h:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->j:I
    ...
    iget v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->q:I

    iget v5, p1, Landroid/support/v4/app/NotificationCompat$Builder;->r:I

    iget-boolean v6, p1, Landroid/support/v4/app/NotificationCompat$Builder;->s:Z
    ...
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->o:Ljava/lang/CharSequence;
    ...
    iget-boolean v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->m:Z
    ...
    iget v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->k:I

    .line 95
    invoke-virtual {v0, v4}, Landroid/app/Notification$Builder;->setPriority(I)Landroid/app/Notification$Builder;

    .line 97
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->b:Ljava/util/ArrayList;
    ...
    .line 98
    invoke-direct {p0, v0}, Landroid/support/v4/app/NotificationCompatBuilder;->a(Landroid/support/v4/app/NotificationCompat$Action;)V
    ...
    .line 101
    :cond_6
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->A:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    .line 102
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompatBuilder;->f:Landroid/os/Bundle;

    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->A:Landroid/os/Bundle;
    ...
    .line 105
    iget-boolean v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->w:Z
    ...
    .line 108
    :cond_8
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->t:Ljava/lang/String;
    ...
    iget-object v5, p1, Landroid/support/v4/app/NotificationCompat$Builder;->t:Ljava/lang/String;

    invoke-virtual {v0, v4, v5}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 110
    iget-boolean v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->u:Z
    ...
    :cond_9
    :goto_6
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->v:Ljava/lang/String;
    ...
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->v:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v4/app/NotificationCompatBuilder;->c:Landroid/widget/RemoteViews;

    .line 123
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->F:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroid/support/v4/app/NotificationCompatBuilder;->d:Landroid/widget/RemoteViews;
    ...
    iget-boolean v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->l:Z
    ...
    .line 129
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->N:Ljava/util/ArrayList;
    ...
    iget-object v5, p1, Landroid/support/v4/app/NotificationCompat$Builder;->N:Ljava/util/ArrayList;
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->t:Ljava/lang/String;
    ...
    iget-boolean v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->u:Z
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->v:Ljava/lang/String;

    .line 139
    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setSortKey(Ljava/lang/String;)Landroid/app/Notification$Builder;

    .line 141
    iget v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->L:I

    iput v0, p0, Landroid/support/v4/app/NotificationCompatBuilder;->g:I
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->z:Ljava/lang/String;
    ...
    iget v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->C:I
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->D:Landroid/app/Notification;
    ...
    .line 153
    :cond_f
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->G:Landroid/widget/RemoteViews;
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->A:Landroid/os/Bundle;

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->p:[Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->E:Landroid/widget/RemoteViews;
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->F:Landroid/widget/RemoteViews;
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->G:Landroid/widget/RemoteViews;
    ...
    iget v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->I:I

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setBadgeIconType(I)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->J:Ljava/lang/String;
    ...
    iget-wide v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->K:J
    ...
    iget v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->L:I

    .line 172
    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setGroupAlertBehavior(I)Landroid/app/Notification$Builder;

    .line 173
    iget-boolean v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->y:Z
    ...
    iget-boolean v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->x:Z

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setColorized(Z)Landroid/app/Notification$Builder;

    .line 177
    :cond_14
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->H:Ljava/lang/String;
...
.method private a(Landroid/support/v4/app/NotificationCompat$Action;)V
    ...
    .line 233
    invoke-virtual {p1}, Landroid/support/v4/app/NotificationCompat$Action;->a()I

    move-result v0

    invoke-virtual {p1}, Landroid/support/v4/app/NotificationCompat$Action;->b()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p1}, Landroid/support/v4/app/NotificationCompat$Action;->c()Landroid/app/PendingIntent;
    ...
    .line 234
    invoke-virtual {p1}, Landroid/support/v4/app/NotificationCompat$Action;->f()[Landroid/support/v4/app/RemoteInput;
    ...
    .line 235
    invoke-static {v0}, Landroid/support/v4/app/RemoteInput;->a([Landroid/support/v4/app/RemoteInput;)[Landroid/app/RemoteInput;
    ...
    .line 241
    :cond_0
    invoke-virtual {p1}, Landroid/support/v4/app/NotificationCompat$Action;->d()Landroid/os/Bundle;
    ...
    .line 247
    invoke-virtual {p1}, Landroid/support/v4/app/NotificationCompat$Action;->e()Z
    ...
    .line 255
    invoke-static {v1, p1}, Landroid/support/v4/app/NotificationCompatJellybean;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
...
.method public b()Landroid/app/Notification;
    ...
    .line 192
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompatBuilder;->b:Landroid/support/v4/app/NotificationCompat$Builder;

    iget-object v1, v0, Landroid/support/v4/app/NotificationCompat$Builder;->n:Landroid/support/v4/app/NotificationCompat$Style;

    .line 193
    if-eqz v1, :cond_0

    .line 194
    invoke-virtual {v1, p0}, Landroid/support/v4/app/NotificationCompat$Style;->a(Landroid/support/v4/app/NotificationBuilderWithBuilderAccessor;)V
    ...
    .line 198
    invoke-virtual {v1, p0}, Landroid/support/v4/app/NotificationCompat$Style;->b(Landroid/support/v4/app/NotificationBuilderWithBuilderAccessor;)Landroid/widget/RemoteViews;
    ...
    .line 207
    invoke-virtual {v1, p0}, Landroid/support/v4/app/NotificationCompat$Style;->c(Landroid/support/v4/app/NotificationBuilderWithBuilderAccessor;)Landroid/widget/RemoteViews;
    ...
    iget-object v0, v0, Landroid/support/v4/app/NotificationCompat$Builder;->n:Landroid/support/v4/app/NotificationCompat$Style;

    .line 214
    invoke-virtual {v0, p0}, Landroid/support/v4/app/NotificationCompat$Style;->d(Landroid/support/v4/app/NotificationBuilderWithBuilderAccessor;)Landroid/widget/RemoteViews;
    ...
    .line 223
    invoke-virtual {v1, v0}, Landroid/support/v4/app/NotificationCompat$Style;->a(Landroid/os/Bundle;)V
...
.method protected c()Landroid/app/Notification;
    ...
    .line 356
    invoke-static {v1}, Landroid/support/v4/app/NotificationCompat;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 371
    :cond_12
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompatBuilder;->c:Landroid/widget/RemoteViews;
    ...
    .line 374
    :cond_13
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompatBuilder;->d:Landroid/widget/RemoteViews;
