...
.method constructor <init>(Landroid/content/res/ColorStateList;F)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RoundRectDrawable;->b:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RoundRectDrawable;->c:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RoundRectDrawable;->d:Landroid/graphics/Rect;
...
.method private a(Landroid/graphics/Rect;)V
    ...
    .line 114
    iget v1, p0, Landroid/support/v7/widget/RoundRectDrawable;->e:F

    iget v2, p0, Landroid/support/v7/widget/RoundRectDrawable;->a:F

    iget-boolean v3, p0, Landroid/support/v7/widget/RoundRectDrawable;->g:Z
    ...
    .line 115
    iget-object v2, p0, Landroid/support/v7/widget/RoundRectDrawable;->d:Landroid/graphics/Rect;
...
.method private b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/RoundRectDrawable;->h:Landroid/content/res/ColorStateList;
...
.method a(F)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/RoundRectDrawable;->a(Landroid/graphics/Rect;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .prologue
    .line 89
    iget-object v1, p0, Landroid/support/v7/widget/RoundRectDrawable;->b:Landroid/graphics/Paint;

    .line 92
    iget-object v0, p0, Landroid/support/v7/widget/RoundRectDrawable;->i:Landroid/graphics/PorterDuffColorFilter;
...
.method protected onStateChange([I)Z
    ...
    .line 188
    iget-object v3, p0, Landroid/support/v7/widget/RoundRectDrawable;->b:Landroid/graphics/Paint;

    invoke-virtual {v3, v2}, Landroid/graphics/Paint;->setColor(I)V

    .line 190
    :cond_0
    iget-object v2, p0, Landroid/support/v7/widget/RoundRectDrawable;->j:Landroid/content/res/ColorStateList;

    if-eqz v2, :cond_2

    iget-object v2, p0, Landroid/support/v7/widget/RoundRectDrawable;->k:Landroid/graphics/PorterDuff$Mode;

    if-eqz v2, :cond_2

    .line 191
    iget-object v1, p0, Landroid/support/v7/widget/RoundRectDrawable;->j:Landroid/content/res/ColorStateList;

    iget-object v2, p0, Landroid/support/v7/widget/RoundRectDrawable;->k:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/RoundRectDrawable;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/RoundRectDrawable;->i:Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RoundRectDrawable;->k:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, v0, v1}, Landroid/support/v7/widget/RoundRectDrawable;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/RoundRectDrawable;->i:Landroid/graphics/PorterDuffColorFilter;
