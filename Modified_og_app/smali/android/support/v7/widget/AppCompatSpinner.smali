...
.field private g:Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Landroid/support/v7/widget/AppCompatBackgroundHelper;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->c:Landroid/content/Context;
    ...
    invoke-static {v2, p2, v4, p3, v6}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v2, v4, v5}, Landroid/support/v7/widget/TintTypedArray;->f(II)I
    ...
    .line 240
    invoke-virtual {v2, v4}, Landroid/support/v7/widget/TintTypedArray;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    .line 239
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(Landroid/graphics/drawable/Drawable;)V

    .line 241
    sget v4, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_prompt:I

    invoke-virtual {v3, v4}, Landroid/support/v7/widget/TintTypedArray;->d(I)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(Ljava/lang/CharSequence;)V

    .line 242
    invoke-virtual {v2}, Landroid/support/v7/widget/TintTypedArray;->a()V

    .line 244
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/widget/ForwardingListener;

    .line 262
    :cond_2
    sget v0, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_entries:I

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/TintTypedArray;->f(I)[Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3, v0, v6}, Landroid/support/v7/widget/TintTypedArray;->g(II)I
    ...
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->c:Landroid/content/Context;
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner;)Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
    .locals 1

    .prologue
    .line 68
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->j()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->k()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->h()Landroid/graphics/drawable/Drawable;
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->e()V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 397
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->c(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(Landroid/graphics/drawable/Drawable;)V
