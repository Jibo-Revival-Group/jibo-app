...
.method constructor <init>(Landroid/support/v7/widget/ViewBoundsCheck$Callback;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ViewBoundsCheck;->b:Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;
...
.method a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ViewBoundsCheck$Callback;->b()I
    ...
    invoke-interface {v1, p1}, Landroid/support/v7/widget/ViewBoundsCheck$Callback;->a(I)Landroid/view/View;
    ...
    invoke-interface {v5, v1}, Landroid/support/v7/widget/ViewBoundsCheck$Callback;->a(Landroid/view/View;)I
    ...
    invoke-interface {v6, v1}, Landroid/support/v7/widget/ViewBoundsCheck$Callback;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v7, v3, v4, v5, v6}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->a(IIII)V
    ...
    invoke-virtual {v5}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->a()V

    .line 227
    iget-object v5, p0, Landroid/support/v7/widget/ViewBoundsCheck;->b:Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;

    invoke-virtual {v5, p3}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->a(I)V

    .line 228
    iget-object v5, p0, Landroid/support/v7/widget/ViewBoundsCheck;->b:Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;

    invoke-virtual {v5}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->b()Z
...
.method a(Landroid/view/View;I)Z
    ...
    .line 251
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->a(IIII)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->a()V

    .line 255
    iget-object v0, p0, Landroid/support/v7/widget/ViewBoundsCheck;->b:Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;

    invoke-virtual {v0, p2}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->a(I)V

    .line 256
    iget-object v0, p0, Landroid/support/v7/widget/ViewBoundsCheck;->b:Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;

    invoke-virtual {v0}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->b()Z
