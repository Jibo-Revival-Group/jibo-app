...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatTextHelper;->f:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    iget v3, p0, Landroid/support/v7/widget/AppCompatTextHelper;->g:I

    invoke-virtual {p2, v0, v3}, Landroid/support/v7/widget/TintTypedArray;->a(II)I
    ...
    iget-object v4, p0, Landroid/support/v7/widget/AppCompatTextHelper;->a:Landroid/widget/TextView;
    ...
    invoke-virtual {p2, v0, v3, v4}, Landroid/support/v7/widget/TintTypedArray;->a(IILandroid/support/v4/content/res/ResourcesCompat$FontCallback;)Landroid/graphics/Typeface;

    move-result-object v3

    iput-object v3, p0, Landroid/support/v7/widget/AppCompatTextHelper;->h:Landroid/graphics/Typeface;

    .line 236
    iget-object v3, p0, Landroid/support/v7/widget/AppCompatTextHelper;->h:Landroid/graphics/Typeface;
...
.method a(Landroid/content/Context;I)V
    ...
    .line 302
    :cond_1
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/AppCompatTextHelper;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v7, p1, v3, p2, v2}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v3, v4, v9}, Landroid/support/v7/widget/TintTypedArray;->g(II)I
    ...
    invoke-virtual {v3, v6}, Landroid/support/v7/widget/TintTypedArray;->g(I)Z
    ...
    .line 88
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/TintTypedArray;->g(II)I

    move-result v6

    .line 87
    invoke-static {v7, v0, v6}, Landroid/support/v7/widget/AppCompatTextHelper;->a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/TintInfo;
    ...
    .line 102
    :cond_3
    invoke-virtual {v3}, Landroid/support/v7/widget/TintTypedArray;->a()V
    ...
    invoke-static {v7, v4, v0}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v9, v0}, Landroid/support/v7/widget/TintTypedArray;->g(I)Z
    ...
    invoke-virtual {v9, v0, v2}, Landroid/support/v7/widget/TintTypedArray;->a(IZ)Z
    ...
    .line 123
    :goto_0
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/AppCompatTextHelper;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/TintTypedArray;->g(I)Z
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/TintTypedArray;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/TintTypedArray;->g(I)Z
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/TintTypedArray;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v10}, Landroid/support/v7/widget/TintTypedArray;->g(I)Z
    ...
    invoke-virtual {v9, v5}, Landroid/support/v7/widget/TintTypedArray;->e(I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    :goto_3
    invoke-virtual {v9}, Landroid/support/v7/widget/TintTypedArray;->a()V

    .line 143
    :goto_4
    sget-object v9, Landroid/support/v7/appcompat/R$styleable;->TextAppearance:[I

    invoke-static {v7, p1, v9, p2, v2}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/widget/TintTypedArray;->g(I)Z
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/widget/TintTypedArray;->e(I)Landroid/content/res/ColorStateList;
    ...
    .line 197
    invoke-virtual {v1}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->c()I

    move-result v1

    iget-object v3, p0, Landroid/support/v7/widget/AppCompatTextHelper;->f:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;

    .line 198
    invoke-virtual {v3}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->d()I

    move-result v3

    iget-object v4, p0, Landroid/support/v7/widget/AppCompatTextHelper;->f:Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;

    .line 199
    invoke-virtual {v4}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->b()I
