...
.method public constructor <init>(Landroid/support/constraint/solver/widgets/ConstraintAnchor;)V
    ...
    .line 49
    invoke-virtual {p1}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->f()Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    iput v0, p0, Landroid/support/constraint/solver/widgets/Snapshot$Connection;->e:I
...
.method public a(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/Snapshot$Connection;->a:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual {v0}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->f()Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual {v0}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->e()Landroid/support/constraint/solver/widgets/ConstraintAnchor$Strength;
    ...
    invoke-virtual {v0}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->h()I
    ...
    .line 69
    iput v1, p0, Landroid/support/constraint/solver/widgets/Snapshot$Connection;->c:I
    ...
    .line 71
    iput v1, p0, Landroid/support/constraint/solver/widgets/Snapshot$Connection;->e:I
...
.method public b(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 82
    iget-object v1, p0, Landroid/support/constraint/solver/widgets/Snapshot$Connection;->b:Landroid/support/constraint/solver/widgets/ConstraintAnchor;

    iget v2, p0, Landroid/support/constraint/solver/widgets/Snapshot$Connection;->c:I

    iget-object v3, p0, Landroid/support/constraint/solver/widgets/Snapshot$Connection;->d:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Strength;

    iget v4, p0, Landroid/support/constraint/solver/widgets/Snapshot$Connection;->e:I
