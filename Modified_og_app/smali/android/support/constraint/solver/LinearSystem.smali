...
.method private a(Landroid/support/constraint/solver/SolverVariable$Type;)Landroid/support/constraint/solver/SolverVariable;
    ...
    iget-object v0, v0, Landroid/support/constraint/solver/Cache;->b:Landroid/support/constraint/solver/Pools$Pool;
...
.method private a(Landroid/support/constraint/solver/ArrayRow;I)V
    ...
    .line 197
    invoke-virtual {p1, v0, p2}, Landroid/support/constraint/solver/ArrayRow;->c(Landroid/support/constraint/solver/SolverVariable;I)Landroid/support/constraint/solver/ArrayRow;
...
.method private b(Landroid/support/constraint/solver/Goal;)I
    ...
    .line 450
    invoke-virtual {p1}, Landroid/support/constraint/solver/Goal;->a()Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 455
    iget-object v4, p0, Landroid/support/constraint/solver/LinearSystem;->j:[Z

    iget v5, v0, Landroid/support/constraint/solver/SolverVariable;->a:I
    ...
    .line 483
    :goto_3
    iget v5, p0, Landroid/support/constraint/solver/LinearSystem;->k:I

    if-ge v0, v5, :cond_4

    .line 484
    iget-object v5, p0, Landroid/support/constraint/solver/LinearSystem;->i:[Landroid/support/constraint/solver/ArrayRow;

    aget-object v5, v5, v0

    .line 485
    iget-object v11, v5, Landroid/support/constraint/solver/ArrayRow;->a:Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 460
    iget v4, p0, Landroid/support/constraint/solver/LinearSystem;->b:I
    ...
    .line 490
    :cond_3
    invoke-virtual {v5, v8}, Landroid/support/constraint/solver/ArrayRow;->a(Landroid/support/constraint/solver/SolverVariable;)Z
    ...
    .line 493
    iget-object v11, v5, Landroid/support/constraint/solver/ArrayRow;->d:Landroid/support/constraint/solver/ArrayLinkedVariables;

    invoke-virtual {v11, v8}, Landroid/support/constraint/solver/ArrayLinkedVariables;->c(Landroid/support/constraint/solver/SolverVariable;)F
    ...
    .line 512
    iget-object v0, v4, Landroid/support/constraint/solver/ArrayRow;->a:Landroid/support/constraint/solver/SolverVariable;

    iput v3, v0, Landroid/support/constraint/solver/SolverVariable;->b:I

    .line 513
    invoke-virtual {v4, v8}, Landroid/support/constraint/solver/ArrayRow;->b(Landroid/support/constraint/solver/SolverVariable;)V
    ...
    invoke-virtual {v2, v4}, Landroid/support/constraint/solver/ArrayRow;->a(Landroid/support/constraint/solver/ArrayRow;)Z
    ...
    .line 526
    :try_start_0
    invoke-direct {p0, p1}, Landroid/support/constraint/solver/LinearSystem;->c(Landroid/support/constraint/solver/Goal;)I
    :try_end_0
...
.method private b(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 192
    invoke-virtual {p1, v0, v1}, Landroid/support/constraint/solver/ArrayRow;->a(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;)Landroid/support/constraint/solver/ArrayRow;

    .line 193
    return-void
.end method

.method private c(Landroid/support/constraint/solver/Goal;)I
    .locals 17
    ...
    iget-object v8, v8, Landroid/support/constraint/solver/Cache;->c:[Landroid/support/constraint/solver/SolverVariable;
    ...
    invoke-virtual {v5, v2}, Landroid/support/constraint/solver/ArrayRow;->b(Landroid/support/constraint/solver/SolverVariable;)V
...
.method private c(Landroid/support/constraint/solver/ArrayRow;)V
    .locals 2
...
.method private g()V
    ...
    iget-object v0, v0, Landroid/support/constraint/solver/Cache;->c:[Landroid/support/constraint/solver/SolverVariable;
    ...
    iput-object v0, v1, Landroid/support/constraint/solver/Cache;->c:[Landroid/support/constraint/solver/SolverVariable;
...
.method private h()V
    ...
    iget-object v2, v2, Landroid/support/constraint/solver/Cache;->a:Landroid/support/constraint/solver/Pools$Pool;
...
# virtual methods
.method a(I)Landroid/support/constraint/solver/ArrayRow;
    .locals 1
...
.method public a(Ljava/lang/Object;)Landroid/support/constraint/solver/SolverVariable;
    ...
    invoke-virtual {v0, v1}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->a(Landroid/support/constraint/solver/Cache;)V
...
.method public a(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 373
    invoke-virtual {p1}, Landroid/support/constraint/solver/ArrayRow;->e()V

    .line 380
    invoke-virtual {p1}, Landroid/support/constraint/solver/ArrayRow;->f()V

    .line 382
    invoke-virtual {p1}, Landroid/support/constraint/solver/ArrayRow;->b()Z
    ...
    iget-object v1, v1, Landroid/support/constraint/solver/Cache;->a:Landroid/support/constraint/solver/Pools$Pool;
...
.method a(Landroid/support/constraint/solver/Goal;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public a(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;IFLandroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    .line 857
    invoke-virtual/range {v1 .. v8}, Landroid/support/constraint/solver/ArrayRow;->a(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;IFLandroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;I)Landroid/support/constraint/solver/ArrayRow;
    ...
    iput v0, v2, Landroid/support/constraint/solver/SolverVariable;->c:I

    .line 861
    move/from16 v0, p8

    iput v0, v3, Landroid/support/constraint/solver/SolverVariable;->c:I

    .line 862
    invoke-virtual {v1, v2, v3}, Landroid/support/constraint/solver/ArrayRow;->a(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;)Landroid/support/constraint/solver/ArrayRow;

    .line 863
    invoke-virtual {p0, v1}, Landroid/support/constraint/solver/LinearSystem;->a(Landroid/support/constraint/solver/ArrayRow;)V
...
.method public b()Landroid/support/constraint/solver/ArrayRow;
    .locals 2
    ...
    iget-object v0, v0, Landroid/support/constraint/solver/Cache;->a:Landroid/support/constraint/solver/Pools$Pool;
    ...
    .line 171
    :cond_0
    invoke-virtual {v0}, Landroid/support/constraint/solver/ArrayRow;->d()V
...
.method public e()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/constraint/solver/LinearSystem;->a(Landroid/support/constraint/solver/Goal;)V

    .line 317
    return-void
.end method

.method public f()Landroid/support/constraint/solver/Cache;
    .locals 1
