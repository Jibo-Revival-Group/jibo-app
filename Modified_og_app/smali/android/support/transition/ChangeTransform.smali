...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 110
    sget-object v0, Landroid/support/transition/Styleable;->g:[I
    ...
    invoke-static {v1, v0, v2, v3, v3}, Landroid/support/v4/content/res/TypedArrayUtils;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
    ...
    invoke-static {v1, p2, v0, v2, v3}, Landroid/support/v4/content/res/TypedArrayUtils;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
...
.method private a(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
    ...
    .line 285
    sget-object v0, Landroid/support/transition/MatrixUtils;->a:Landroid/graphics/Matrix;
    ...
    .line 289
    sget-object v3, Landroid/support/transition/MatrixUtils;->a:Landroid/graphics/Matrix;
    ...
    .line 364
    invoke-static {v7, v0}, Landroid/support/transition/AnimatorUtils;->a(Landroid/animation/Animator;Landroid/animation/AnimatorListenerAdapter;)V
...
.method private a(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    .line 373
    :cond_3
    invoke-virtual {p0, p1, v0}, Landroid/support/transition/ChangeTransform;->b(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
...
.method private b(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)V
    .locals 4
...
.method private static b(Landroid/view/View;FFFFFFFF)V
    ...
    .line 443
    invoke-static {p0, p3}, Landroid/support/v4/view/ViewCompat;->b(Landroid/view/View;F)V
...
.method private b(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)V
    ...
    .line 389
    invoke-static {v1, p1, v2}, Landroid/support/transition/GhostViewUtils;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)Landroid/support/transition/GhostViewImpl;
    ...
    invoke-interface {v2, v0, v3}, Landroid/support/transition/GhostViewImpl;->a(Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    .line 403
    invoke-virtual {p0, v0}, Landroid/support/transition/Transition;->a(Landroid/support/transition/Transition$TransitionListener;)Landroid/support/transition/Transition;
    ...
    iget-object v2, p3, Landroid/support/transition/TransitionValues;->b:Landroid/view/View;
    ...
    invoke-static {v0, v2}, Landroid/support/transition/ViewUtils;->a(Landroid/view/View;F)V

    .line 411
    :cond_3
    const/high16 v0, 0x3f800000    # 1.0f

    invoke-static {v1, v0}, Landroid/support/transition/ViewUtils;->a(Landroid/view/View;F)V
...
.method private d(Landroid/support/transition/TransitionValues;)V
    ...
    .line 209
    invoke-static {v0, v2}, Landroid/support/transition/ViewUtils;->a(Landroid/view/View;Landroid/graphics/Matrix;)V
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 251
    iget-object v3, p2, Landroid/support/transition/TransitionValues;->a:Ljava/util/Map;
    ...
    .line 262
    invoke-direct {p0, p2, p3}, Landroid/support/transition/ChangeTransform;->b(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)V

    .line 266
    :cond_4
    invoke-direct {p0, p2, p3, v2}, Landroid/support/transition/ChangeTransform;->a(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
    ...
    .line 270
    invoke-direct {p0, p1, p2, p3}, Landroid/support/transition/ChangeTransform;->b(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)V
