...
.method public constructor <init>(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 74
    iput v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->d:I

    .line 76
    iput-boolean v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:Z

    .line 77
    iput-boolean v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->f:Z
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->b:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private a(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    iget-boolean v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->f:Z
    ...
    .line 289
    :goto_0
    iget-object v3, v1, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private b(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 131
    iget-boolean v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:Z

    if-nez v0, :cond_1

    iget v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->d:I
...
.method private b()Z
    ...
    iget-object v2, v0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;

    .line 146
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->a:Landroid/arch/core/internal/FastSafeIterableMap;

    invoke-virtual {v0}, Landroid/arch/core/internal/FastSafeIterableMap;->e()Ljava/util/Map$Entry;
...
.method private c(Landroid/arch/lifecycle/LifecycleObserver;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-object v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->g:Ljava/util/ArrayList;
...
.method private d()V
    ...
    .line 324
    iput-boolean v3, p0, Landroid/arch/lifecycle/LifecycleRegistry;->f:Z
    ...
    invoke-virtual {v1}, Landroid/arch/core/internal/FastSafeIterableMap;->d()Ljava/util/Map$Entry;
...
.method public a(Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    .line 123
    invoke-direct {p0, v0}, Landroid/arch/lifecycle/LifecycleRegistry;->b(Landroid/arch/lifecycle/Lifecycle$State;)V
...
.method public a(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    invoke-virtual {v0, p1, v3}, Landroid/arch/core/internal/FastSafeIterableMap;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 174
    iget v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->d:I

    if-nez v1, :cond_3

    iget-boolean v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:Z
    ...
    .line 176
    iget v4, p0, Landroid/arch/lifecycle/LifecycleRegistry;->d:I

    add-int/lit8 v4, v4, 0x1

    iput v4, p0, Landroid/arch/lifecycle/LifecycleRegistry;->d:I

    .line 177
    :goto_3
    iget-object v4, v3, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 178
    invoke-virtual {v2, p1}, Landroid/arch/core/internal/FastSafeIterableMap;->c(Ljava/lang/Object;)Z
    ...
    .line 179
    iget-object v2, v3, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-direct {p0, v2}, Landroid/arch/lifecycle/LifecycleRegistry;->c(Landroid/arch/lifecycle/Lifecycle$State;)V

    .line 180
    iget-object v2, v3, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-static {v2}, Landroid/arch/lifecycle/LifecycleRegistry;->e(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;
