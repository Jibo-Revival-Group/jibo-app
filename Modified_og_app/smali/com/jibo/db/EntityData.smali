...
.method public a(Lcom/jibo/aws/integration/util/Commons$AsyncCallback;)V
    ...
    invoke-interface {p1, v0}, Lcom/jibo/aws/integration/util/Commons$AsyncCallback;->onSuccess(Ljava/lang/Object;)V
...
.method public declared-synchronized i()Lcom/jibo/aws/integration/aws/services/account/model/Account;
    ...
    if-eqz v0, :cond_mock_init_skip

    invoke-virtual {v0}, Lcom/jibo/aws/integration/aws/services/account/model/Account;->getEmail()Ljava/lang/String;

    move-result-object v1

    const-string v2, "jibo@jiborevival.com"

    invoke-virtual {v2, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result v1

    if-eqz v1, :cond_mock_init_skip

    const/4 v1, 0x1

    sput-boolean v1, Lcom/jibo/aws/integration/util/Commons;->IS_MOCK_MODE:Z
