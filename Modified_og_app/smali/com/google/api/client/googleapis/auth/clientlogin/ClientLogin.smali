...
.method public authenticate()Lcom/google/api/client/googleapis/auth/clientlogin/ClientLogin$Response;
    ...
    .line 179
    invoke-virtual {v0, v3}, Lcom/google/api/client/http/HttpRequest;->setContentLoggingLimit(I)Lcom/google/api/client/http/HttpRequest;
    ...
    .line 184
    const-class v0, Lcom/google/api/client/googleapis/auth/clientlogin/ClientLogin$Response;
    ...
    invoke-direct {v2, v0, v3, v4}, Lcom/google/api/client/http/HttpResponseException$Builder;-><init>(ILjava/lang/String;Lcom/google/api/client/http/HttpHeaders;)V

    .line 189
    const-class v0, Lcom/google/api/client/googleapis/auth/clientlogin/ClientLogin$ErrorInfo;

    invoke-virtual {v1, v0}, Lcom/google/api/client/http/HttpResponse;->parseAs(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/google/api/client/googleapis/auth/clientlogin/ClientLogin$ErrorInfo;
    ...
    .line 191
    invoke-static {v1}, Lcom/google/api/client/http/HttpResponseException;->computeMessageBuffer(Lcom/google/api/client/http/HttpResponse;)Ljava/lang/StringBuilder;
    ...
    .line 194
    invoke-virtual {v2, v3}, Lcom/google/api/client/http/HttpResponseException$Builder;->setContent(Ljava/lang/String;)Lcom/google/api/client/http/HttpResponseException$Builder;
    ...
    invoke-virtual {v2, v1}, Lcom/google/api/client/http/HttpResponseException$Builder;->setMessage(Ljava/lang/String;)Lcom/google/api/client/http/HttpResponseException$Builder;

    .line 197
    new-instance v1, Lcom/google/api/client/googleapis/auth/clientlogin/ClientLoginResponseException;

    invoke-direct {v1, v2, v0}, Lcom/google/api/client/googleapis/auth/clientlogin/ClientLoginResponseException;-><init>(Lcom/google/api/client/http/HttpResponseException$Builder;Lcom/google/api/client/googleapis/auth/clientlogin/ClientLogin$ErrorInfo;)V
