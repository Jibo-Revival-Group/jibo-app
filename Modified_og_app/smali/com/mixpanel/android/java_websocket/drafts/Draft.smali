...
.method public static a(Ljava/nio/ByteBuffer;Lcom/mixpanel/android/java_websocket/WebSocket$Role;)Lcom/mixpanel/android/java_websocket/handshake/HandshakeBuilder;
    .locals 7
    ...
    .line 82
    invoke-static {p0}, Lcom/mixpanel/android/java_websocket/drafts/Draft;->b(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    ...
    invoke-interface {v0, v3}, Lcom/mixpanel/android/java_websocket/handshake/ServerHandshakeBuilder;->a(S)V

    .line 96
    aget-object v2, v2, v6

    invoke-interface {v0, v2}, Lcom/mixpanel/android/java_websocket/handshake/ServerHandshakeBuilder;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v1, v0}, Lcom/mixpanel/android/java_websocket/handshake/ClientHandshakeBuilder;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v1, v2, v0}, Lcom/mixpanel/android/java_websocket/handshake/HandshakeBuilder;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    ...
    .prologue
    .line 75
    invoke-static {p0}, Lcom/mixpanel/android/java_websocket/drafts/Draft;->a(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v1, v2, v0}, Lcom/mixpanel/android/java_websocket/util/Charsetfunctions;->a([BII)Ljava/lang/String;
...
.method public abstract a(Lcom/mixpanel/android/java_websocket/handshake/ClientHandshake;)Lcom/mixpanel/android/java_websocket/drafts/Draft$HandshakeState;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/mixpanel/android/java_websocket/exceptions/InvalidHandshakeException;
        }
...
.method public abstract a(Lcom/mixpanel/android/java_websocket/handshake/ClientHandshakeBuilder;)Lcom/mixpanel/android/java_websocket/handshake/ClientHandshakeBuilder;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/mixpanel/android/java_websocket/exceptions/InvalidHandshakeException;
        }
...
.method public abstract a(Lcom/mixpanel/android/java_websocket/handshake/ClientHandshake;Lcom/mixpanel/android/java_websocket/handshake/ServerHandshakeBuilder;)Lcom/mixpanel/android/java_websocket/handshake/HandshakeBuilder;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/mixpanel/android/java_websocket/exceptions/InvalidHandshakeException;
        }
...
.method public a(Lcom/mixpanel/android/java_websocket/framing/Framedata$Opcode;Ljava/nio/ByteBuffer;Z)Ljava/util/List;
    .locals 2
    ...
    .line 144
    :try_start_0
    invoke-interface {v0, p2}, Lcom/mixpanel/android/java_websocket/framing/FrameBuilder;->a(Ljava/nio/ByteBuffer;)V
    :try_end_0
    .catch Lcom/mixpanel/android/java_websocket/exceptions/InvalidDataException; {:try_start_0 .. :try_end_0} :catch_0

    .line 148
    invoke-interface {v0, p3}, Lcom/mixpanel/android/java_websocket/framing/FrameBuilder;->a(Z)V
...
.method public a(Lcom/mixpanel/android/java_websocket/handshake/Handshakedata;Lcom/mixpanel/android/java_websocket/WebSocket$Role;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/mixpanel/android/java_websocket/drafts/Draft;->a(Lcom/mixpanel/android/java_websocket/handshake/Handshakedata;Lcom/mixpanel/android/java_websocket/WebSocket$Role;Z)Ljava/util/List;
...
.method public a(Lcom/mixpanel/android/java_websocket/handshake/Handshakedata;Lcom/mixpanel/android/java_websocket/WebSocket$Role;Z)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 175
    invoke-interface {p1}, Lcom/mixpanel/android/java_websocket/handshake/Handshakedata;->b()Ljava/util/Iterator;
    ...
    .line 178
    invoke-interface {p1, v0}, Lcom/mixpanel/android/java_websocket/handshake/Handshakedata;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0}, Lcom/mixpanel/android/java_websocket/handshake/ServerHandshake;->a()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lcom/mixpanel/android/java_websocket/handshake/Handshakedata;->c()[B
...
.method public a(Lcom/mixpanel/android/java_websocket/WebSocket$Role;)V
    .locals 0
...
.method protected a(Lcom/mixpanel/android/java_websocket/handshake/Handshakedata;)Z
    .locals 2
...
.method public d(Ljava/nio/ByteBuffer;)Lcom/mixpanel/android/java_websocket/handshake/Handshakedata;
    ...
    invoke-static {p1, v0}, Lcom/mixpanel/android/java_websocket/drafts/Draft;->a(Ljava/nio/ByteBuffer;Lcom/mixpanel/android/java_websocket/WebSocket$Role;)Lcom/mixpanel/android/java_websocket/handshake/HandshakeBuilder;
