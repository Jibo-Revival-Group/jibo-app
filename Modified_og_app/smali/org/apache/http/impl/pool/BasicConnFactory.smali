...
.method public create(Lorg/apache/http/HttpHost;)Lorg/apache/http/HttpClientConnection;
    ...
    invoke-virtual {v3}, Lorg/apache/http/config/SocketConfig;->getSndBufSize()I
    ...
    invoke-virtual {v3}, Lorg/apache/http/config/SocketConfig;->getRcvBufSize()I
    ...
    invoke-virtual {v3}, Lorg/apache/http/config/SocketConfig;->isTcpNoDelay()Z
    ...
    invoke-virtual {v3}, Lorg/apache/http/config/SocketConfig;->getSoLinger()I
    ...
    invoke-virtual {v1, v4, v3}, Ljava/net/Socket;->setSoLinger(ZI)V

    .line 179
    :cond_7
    iget-object v3, p0, Lorg/apache/http/impl/pool/BasicConnFactory;->sconfig:Lorg/apache/http/config/SocketConfig;

    invoke-virtual {v3}, Lorg/apache/http/config/SocketConfig;->isSoKeepAlive()Z
