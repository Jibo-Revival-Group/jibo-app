...
.method private downloadFile(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    .line 235
    invoke-virtual {v4, v0}, Lokhttp3/OkHttpClient;->a(Lokhttp3/Request;)Lokhttp3/Call;
    ...
    .line 241
    invoke-interface {v3, v2}, Lokio/BufferedSource;->a(Lokio/Sink;)J
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    .line 251
    :cond_1
    invoke-virtual {v4}, Lokhttp3/OkHttpClient;->s()Lokhttp3/Dispatcher;
