...
.method private b()V
    ...
    iget v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->c:I

    iget v4, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->a:I

    iget-byte v5, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->b:B
...
.method public a(Lokio/Buffer;J)J
    ...
    invoke-interface {v2, v4, v5}, Lokio/BufferedSource;->i(J)V

    .line 366
    const/4 v2, 0x0

    iput-short v2, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->e:S

    .line 367
    iget-byte v2, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->b:B
    ...
    iput v0, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->d:I
