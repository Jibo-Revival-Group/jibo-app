...
.method static constructor <clinit>()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2Codec;->f:Lokio/ByteString;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, Lokhttp3/internal/http2/Http2Codec;->h:Lokio/ByteString;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, Lokhttp3/internal/http2/Http2Codec;->i:Lokio/ByteString;
...
.method public static a(Ljava/util/List;)Lokhttp3/Response$Builder;
    ...
    iget v0, v3, Lokhttp3/internal/http/StatusLine;->b:I
    ...
    .line 166
    :cond_0
    iget-object v6, v0, Lokhttp3/internal/http2/Header;->g:Lokio/ByteString;

    .line 167
    iget-object v0, v0, Lokhttp3/internal/http2/Header;->h:Lokio/ByteString;
    ...
    invoke-virtual {v7, v1, v6, v0}, Lokhttp3/internal/Internal;->a(Lokhttp3/Headers$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, v3, Lokhttp3/internal/http/StatusLine;->c:Ljava/lang/String;
...
.method public static b(Lokhttp3/Request;)Ljava/util/List;
    ...
    .line 142
    sget-object v5, Lokhttp3/internal/http2/Http2Codec;->j:Ljava/util/List;
...
.method public a(Z)Lokhttp3/Response$Builder;
    ...
    invoke-virtual {v1, v0}, Lokhttp3/internal/Internal;->a(Lokhttp3/Response$Builder;)I
...
.method public a(Lokhttp3/Request;)V
    ...
    .line 106
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Codec;->m:Lokhttp3/internal/http2/Http2Connection;

    invoke-virtual {v2, v1, v0}, Lokhttp3/internal/http2/Http2Connection;->a(Ljava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/http2/Http2Codec;->n:Lokhttp3/internal/http2/Http2Stream;

    .line 107
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Codec;->n:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->e()Lokio/Timeout;

    move-result-object v0

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Codec;->l:Lokhttp3/OkHttpClient;
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->f()Lokio/Timeout;
