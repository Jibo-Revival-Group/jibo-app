...
.method constructor <init>(Lokio/BufferedSource;Z)V
    ...
    iput-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->d:Lokhttp3/internal/http2/Http2Reader$ContinuationSource;
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->d:Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v0, v1, v2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILokio/Source;)V

    iput-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->b:Lokhttp3/internal/http2/Hpack$Reader;
...
.method private a(ISBI)Ljava/util/List;
    ...
    iput-short p2, v0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->e:S

    .line 191
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->d:Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    iput-byte p3, v0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->b:B
    ...
    .line 196
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->b:Lokhttp3/internal/http2/Hpack$Reader;

    invoke-virtual {v0}, Lokhttp3/internal/http2/Hpack$Reader;->a()V

    .line 197
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->b:Lokhttp3/internal/http2/Hpack$Reader;

    invoke-virtual {v0}, Lokhttp3/internal/http2/Hpack$Reader;->b()Ljava/util/List;
...
.method private a(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 230
    invoke-interface {p1, p2, v1, v2, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->a(IIIZ)V
...
.method private a(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 182
    invoke-direct {p0, v2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Reader;->a(ISBI)Ljava/util/List;
    ...
    invoke-interface {p1, v1, p4, v2, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->a(ZIILjava/util/List;)V
...
.method private b(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {p1, v2, p4, v3, v1}, Lokhttp3/internal/http2/Http2Reader$Handler;->a(ZILokio/BufferedSource;I)V
...
.method private d(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-static {v1, v2}, Lokhttp3/internal/http2/Http2;->b(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method private e(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v4}, Lokio/BufferedSource;->k()I
    ...
    :goto_2
    :pswitch_0
    invoke-virtual {v3, v0, v4}, Lokhttp3/internal/http2/Settings;->a(II)Lokhttp3/internal/http2/Settings;
    ...
    .line 289
    :cond_6
    invoke-interface {p1, v2, v3}, Lokhttp3/internal/http2/Http2Reader$Handler;->a(ZLokhttp3/internal/http2/Settings;)V
...
.method private f(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 300
    invoke-static {v2, p3, v0}, Lokhttp3/internal/http2/Http2Reader;->a(IBS)I
    ...
    .line 302
    invoke-interface {p1, p4, v1, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->a(IILjava/util/List;)V
...
.method private g(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-static {v2, v0}, Lokhttp3/internal/http2/Http2;->b(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .line 312
    :goto_0
    invoke-interface {p1, v0, v2, v3}, Lokhttp3/internal/http2/Http2Reader$Handler;->a(ZII)V
...
.method private h(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 330
    :cond_3
    invoke-interface {p1, v1, v3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->a(ILokhttp3/internal/http2/ErrorCode;Lokio/ByteString;)V
...
.method private i(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-static {v2, v3}, Lokhttp3/internal/http2/Http2;->b(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method public a(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    .line 80
    invoke-virtual {p0, v6, p1}, Lokhttp3/internal/http2/Http2Reader;->a(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    .line 86
    sget-object v1, Lokhttp3/internal/http2/Http2Reader;->a:Ljava/util/logging/Logger;
...
.method public a(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v2}, Lokhttp3/internal/http2/Http2Reader;->a(Lokio/BufferedSource;)I
    ...
    invoke-static {v3, v0}, Lokhttp3/internal/http2/Http2;->b(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .line 121
    sget-object v5, Lokhttp3/internal/http2/Http2Reader;->a:Ljava/util/logging/Logger;
    ...
    invoke-static {v0, v4, v2, v3, v1}, Lokhttp3/internal/http2/Http2;->a(ZIIBB)Ljava/lang/String;
    ...
    .line 125
    :pswitch_0
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->b(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 129
    :pswitch_1
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->a(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 133
    :pswitch_2
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->c(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 137
    :pswitch_3
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->d(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 141
    :pswitch_4
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->e(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 145
    :pswitch_5
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->f(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 149
    :pswitch_6
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->g(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 153
    :pswitch_7
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->h(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_0

    .line 157
    :pswitch_8
    invoke-direct {p0, p2, v2, v1, v4}, Lokhttp3/internal/http2/Http2Reader;->i(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
