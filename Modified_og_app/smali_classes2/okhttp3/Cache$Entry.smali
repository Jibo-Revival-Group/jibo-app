...
.method constructor <init>(Lokhttp3/Response;)V
    ...
    .line 603
    invoke-virtual {p1}, Lokhttp3/Response;->l()J
...
.method constructor <init>(Lokio/Source;)V
    ...
    .line 543
    invoke-interface {v4}, Lokio/BufferedSource;->r()Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lokhttp3/Cache$Entry;->c:Ljava/lang/String;
    ...
    iput-object v3, p0, Lokhttp3/Cache$Entry;->e:Ljava/lang/String;
    ...
    .line 546
    invoke-static {v4}, Lokhttp3/Cache;->a(Lokio/BufferedSource;)I
    ...
    invoke-virtual {v5, v7}, Lokhttp3/Headers$Builder;->a(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    iput-object v3, p0, Lokhttp3/Cache$Entry;->d:Lokhttp3/Headers;
    ...
    invoke-static {v3}, Lokhttp3/internal/http/StatusLine;->a(Ljava/lang/String;)Lokhttp3/internal/http/StatusLine;

    move-result-object v3

    .line 553
    iget-object v5, v3, Lokhttp3/internal/http/StatusLine;->a:Lokhttp3/Protocol;

    iput-object v5, p0, Lokhttp3/Cache$Entry;->f:Lokhttp3/Protocol;

    .line 554
    iget v5, v3, Lokhttp3/internal/http/StatusLine;->b:I

    iput v5, p0, Lokhttp3/Cache$Entry;->g:I

    .line 555
    iget-object v3, v3, Lokhttp3/internal/http/StatusLine;->c:Ljava/lang/String;

    iput-object v3, p0, Lokhttp3/Cache$Entry;->h:Ljava/lang/String;
    ...
    invoke-virtual {v5, v6}, Lokhttp3/Headers$Builder;->a(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    invoke-virtual {v5, v2}, Lokhttp3/Headers$Builder;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v3}, Lokhttp3/Headers$Builder;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 563
    sget-object v3, Lokhttp3/Cache$Entry;->a:Ljava/lang/String;

    invoke-virtual {v5, v3}, Lokhttp3/Headers$Builder;->b(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    .line 567
    :goto_2
    iput-wide v2, p0, Lokhttp3/Cache$Entry;->k:J
    ...
    .line 580
    invoke-direct {p0, v4}, Lokhttp3/Cache$Entry;->a(Lokio/BufferedSource;)Ljava/util/List;
    ...
    .line 582
    invoke-interface {v4}, Lokio/BufferedSource;->f()Z
...
.method private a(Lokio/BufferedSink;Ljava/util/List;)V
    ...
    .line 685
    invoke-interface {v0, v3}, Lokio/BufferedSink;->k(I)Lokio/BufferedSink;
    :try_end_0
...
.method public a(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 611
    invoke-interface {v1, v6}, Lokio/BufferedSink;->k(I)Lokio/BufferedSink;
    ...
    invoke-interface {v2, v4, v5}, Lokio/BufferedSink;->m(J)Lokio/BufferedSink;
    ...
    .line 620
    invoke-interface {v4, v6}, Lokio/BufferedSink;->k(I)Lokio/BufferedSink;
    ...
    .line 631
    invoke-interface {v3, v6}, Lokio/BufferedSink;->k(I)Lokio/BufferedSink;
    ...
    .line 635
    invoke-interface {v0, v4, v5}, Lokio/BufferedSink;->m(J)Lokio/BufferedSink;

    move-result-object v0

    .line 636
    invoke-interface {v0, v6}, Lokio/BufferedSink;->k(I)Lokio/BufferedSink;
    ...
    .line 643
    invoke-interface {v2, v6}, Lokio/BufferedSink;->k(I)Lokio/BufferedSink;
