...
.method a(Lokhttp3/Response;)Lretrofit2/Response;
    ...
    .line 223
    invoke-virtual {v2}, Lretrofit2/OkHttpCall$ExceptionCatchingRequestBody;->g()V
...
.method public a()Z
    ...
    .line 245
    :try_start_0
    iget-object v1, p0, Lretrofit2/OkHttpCall;->d:Lokhttp3/Call;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lretrofit2/OkHttpCall;->d:Lokhttp3/Call;

    invoke-interface {v1}, Lokhttp3/Call;->d()Z
...
.method public synthetic b()Lretrofit2/Call;
    .locals 1
